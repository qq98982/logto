const role = {
  ...
  internal_role_violation:
    'Możesz próbować zaktualizować lub usunąć rolę wewnętrzną, co jest zabronione przez Aster. Jeśli tworzysz nową rolę, spróbuj innej nazwy, która nie zaczyna się od "#internal:".﻿',
};
