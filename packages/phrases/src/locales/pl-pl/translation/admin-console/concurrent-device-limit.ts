const concurrent_device_limit = {
  ...
  enable_description:
    'Po włączeniu Aster wymusza maksymalną liczbę aktywnych dostępów na użytkownika dla tej aplikacji.',
  field: 'Limit liczby jednoczesnych urządzeń dla aplikacji',
  field_description:
    'Ogranicz, na ilu urządzeniach użytkownik może być jednocześnie zalogowany. Aster wymusza to, ograniczając aktywne dostępy i automatycznie unieważnia najstarszy dostęp, gdy limit zostanie przekroczony.',
