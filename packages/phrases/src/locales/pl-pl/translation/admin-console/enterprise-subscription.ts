const enterprise_subscription = {
  ...
  subscription: {
    ...
    add_on_description:
      'Są to dodatkowe dodatki „płać za użycie” na podstawie twojej umowy lub standardowych stawek „płać za użycie” Aster. Pobierana będzie opłata zgodnie z faktycznym użyciem.',
    included: 'W zestawie',
