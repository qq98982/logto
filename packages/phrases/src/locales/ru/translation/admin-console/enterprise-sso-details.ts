const enterprise_sso_details = {
  ...
  service_provider_property_description:
    'Настройте интеграцию приложения, используя {{protocol}} в вашем поставщике идентичности. Введите детали, предоставленные Aster.',
  attribute_mapping_title: 'Отображение атрибутов',
  attribute_mapping_description:
    'Синхронизация профилей пользователей из поставщика идентичности путем настройки отображения атрибутов пользователя либо на стороне поставщика идентичности, либо на стороне Aster.',
  saml_preview: {
  ...
  idp_initiated_auth_config: {
    ...
    redirect_uri_tooltip:
      'URI перенаправления для перенаправления пользователей после успешного входа. Aster будет использовать этот URI в качестве OIDC URI перенаправления в запросе авторизации. Используйте выделенный URI для потока аутентификации SSO, инициированного IdP, для повышения безопасности.',
  ...
  trust_unverified_email_tip:
    'Коннектор Entra ID (OIDC) не возвращает утверждение `email_verified`, что означает, что адреса электронной почты из Azure не гарантированно проверены. По умолчанию Aster не будет синхронизировать неподтвержденные адреса электронной почты с профилем пользователя. Включайте эту опцию только если вы доверяете всем адресам электронной почты из директории Entra ID.',
  trust_unverified_email_tip_oidc:
    'Коннектор OIDC может не возвращать утверждение `email_verified`, что означает, что адреса электронной почты от IdP не гарантированно проверены. По умолчанию Aster не синхронизирует неподтвержденные адреса электронной почты с профилем пользователя. Включайте эту опцию только если вы доверяете всем адресам электронной почты от IdP.',
  offline_access: {
