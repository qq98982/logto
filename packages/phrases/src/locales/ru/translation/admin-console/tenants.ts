const tenants = {
  ...
  settings: {
    ...
    tenant_instance_description:
      'Выберите, где будет размещен ваш арендатор. Выберите Cloud для общей публичной инфраструктуры или частный экземпляр для выделенных ресурсов.',
    ...
    enterprise_sso_description:
      'Доступно в платных планах. Свяжитесь с нами, чтобы включить Enterprise SSO, чтобы все участники могли входить в консоль Cloud, используя поставщика идентификации вашей организации.',
  },
  full_env_tag: {
  ...
  create_modal: {
    ...
    tenant_id_tip:
      'Настройте идентификатор арендатора. Если оставить пустым, Aster сгенерирует идентификатор по умолчанию. Идентификатор арендатора нельзя изменить после создания.',
  },
  ...
  tenant_landing_page: {
    ...
    description:
      'Чтобы начать настройку вашего проекта с помощью Aster, создайте нового арендатора. Если вам нужно выйти из системы или удалить свою учетную запись, просто нажмите на кнопку аватара в правом верхнем углу.',
