const roles = {
  ...
  management_api_access_notification:
    'Для доступа к API управления Aster выберите роли с разрешениями API управления <flag/>.',
  with_management_api_access_tip:
    'Эта роль от машины к машине включает разрешения для API управления Aster',
