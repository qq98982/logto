...
const sign_in_exp = {
  ...
  color: {
    ...
    dark_mode_description:
      'Ваше приложение будет иметь автоматически созданную темную тему на основе цвета вашего бренда и алгоритма Aster. Вы можете настроить ее по своему вкусу.',
  ...
  custom_ui: {
    ...
    bring_your_ui_description:
      'Загрузите сжатый пакет (.zip), чтобы заменить предустановленный интерфейс Aster вашим собственным кодом. <a>Узнать больше</a>',
  ...
  account_center: {
    ...
    description: 'Настройте процессы центра учётной записи с помощью API Aster.',
    enable_account_api: 'Включить центр учётной записи и Account API',
    enable_account_api_description:
      'Одновременно включает Account API для конечных пользователей и готовый центр аккаунта Aster. При отключении обе функции недоступны.',
    field_options: {
      off: 'Выключено',
      edit: 'Редактировать',
