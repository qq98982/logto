const applications = {
  ...
  title: 'Заявки',
  subtitle:
    'Настроить аутентификацию Aster для вашего нативного, одностраничного, машина-машина или традиционного приложения.',
  subtitle_with_app_type: 'Настроить аутентификацию Aster для вашего приложения {{name}}',
  ...
  type: {
    ...
    protected: {
      ...
      subtitle: 'Приложение, защищенное Aster',
      description: 'N/А',
    },
    saml: {
  ...
  placeholder_description:
    'Aster использует сущность приложения для OIDC для выполнения задач, таких как идентификация ваших приложений, управление входом в систему и создание журналов аудита.',
  third_party_application_placeholder_description:
    'Используйте Aster в качестве поставщика удостоверений, чтобы предоставить авторизацию OAuth сторонним сервисам. \n Включает предустановленный экран согласия пользователя для доступа к ресурсам. <a>Подробнее</a>',
  guide: {
    third_party: {
      title: 'Интегрировать стороннее приложение',
      description:
        'Используйте Aster в качестве поставщика удостоверений, чтобы предоставить OAuth-авторизацию сторонним сервисам. Включает предустановленный экран согласия пользователя для безопасного доступа к ресурсам. <a>Узнать больше</a>',
    },
  },
};
