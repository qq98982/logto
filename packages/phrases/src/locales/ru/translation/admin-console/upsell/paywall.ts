const paywall = {
  ...
  saml_applications_oss_limit_notice:
    'Ваш экземпляр с открытым исходным кодом поддерживает до {{limit}} SAML-приложений.',
  hooks:
  ...
  third_party_apps:
    'Разблокируйте Aster как IdP для сторонних приложений, обновив план до платного. Для получения помощи не стесняйтесь <a>связаться с нами</a>.',
  sso_connectors:
  ...
  branding_customization:
    'Обновите свой план, чтобы получить полный контроль над брендингом с функциями "Скрыть брендинг Aster" и "Создайте свой интерфейс".',
  bring_your_ui:
