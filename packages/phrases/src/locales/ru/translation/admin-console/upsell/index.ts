...
const upsell = {
  ...
  create_tenant: {
    ...
    description:
      'Aster предоставляет конкурентные варианты планов с инновационной и доступной ценой, специально разработанными для растущих компаний. <a>Узнать больше</a>',
  ...
  mau_exceeded_modal: {
    ...
    notification:
      'Текущее количество активных пользователей (MAU) превысило лимит в плане <planName/>. Пожалуйста, незамедлительно обновите свой план до премиум-версии, чтобы избежать приостановки сервиса Aster.',
    update_plan: 'Обновить план',
  },
  token_exceeded_modal: {
    title: 'Превышено использование токенов. Обновите свой план.',
    notification:
      'Вы превысили лимит использования токенов <planName/>. Пользователи не смогут должным образом получить доступ к сервису Aster. Пожалуйста, обновите свой план до премиум-версии, чтобы избежать каких-либо неудобств.',
  },
  payment_overdue_modal: {
    title: 'Просрочен платеж за счет',
    notification:
      'Упс! Оплата счета арендатора <span>{{name}}</span> не удалась. Пожалуйста, оплатите счет немедленно, чтобы избежать приостановки сервиса Aster.',
  ...
  charge_notification_for_quota_limit:
    'Вы превысили лимит вашей квоты по {{item}}. Aster начнет взимать плату за использование сверх вашей квоты. Начисление начнется в день выпуска нового дизайна цен на дополнение. <a>Узнать больше</a>',
  paywall,
