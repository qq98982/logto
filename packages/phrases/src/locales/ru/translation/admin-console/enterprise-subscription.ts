const enterprise_subscription = {
  ...
  subscription: {
    ...
    add_on_description:
      'Это дополнительные дополнения с оплатой по мере использования на основе вашего контракта или стандартных ставок Aster. Вы будете платить в соответствии с вашим фактическим использованием.',
    included: 'Включено',
