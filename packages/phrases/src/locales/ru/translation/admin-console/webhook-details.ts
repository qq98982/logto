const webhook_details = {
  ...
  settings: {
    ...
    events: 'События',
    events_description: 'Выберите события триггеров, которые Aster будет отправлять POST-запрос.',
    name: 'Имя',
    endpoint_url: 'URL-адрес точки доступа',
    signing_key: 'Ключ подписи',
    signing_key_tip:
      'Добавьте секретный ключ, предоставленный Aster, к своей конечной точке в виде заголовка запроса, чтобы обеспечить подлинность нагрузки вебхука.',
