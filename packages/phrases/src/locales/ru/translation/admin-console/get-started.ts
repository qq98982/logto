const get_started = {
  ...
  subtitle: 'Несколько вещей, которые вы можете сделать, чтобы быстро получить ценность от Aster',
  develop: {
  ...
  customize: {
    ...
    preview: {
      ...
      subtitle: 'Попробуйте пробный вариант входа в систему Aster, чтобы узнать, как это работает',
    },
    connector: {
      title:
