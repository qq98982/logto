const quota_table = {
  ...
  mau_tip:
    'MAU (месячно активные пользователи) означает количество уникальных пользователей, которые обменивались как минимум одним токеном с Aster в биллинговом цикле.',
  tokens_tip:
    'Все виды токенов, выпущенных Aster, включая токены доступа, токены обновления и т. д.',
  mao_tip:
  ...
  third_party_tip:
    'Используйте Aster в качестве поставщика идентификации OIDC для входа в сторонние приложения и предоставления разрешений.',
