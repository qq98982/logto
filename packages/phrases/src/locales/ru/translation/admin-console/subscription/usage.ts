const usage = {
  ...
  mau: {
    title: 'MAU',
    tooltip:
      'MAU — это уникальный пользователь, который обменял хотя бы один токен с Aster в течение расчетного цикла. Безлимитно для Pro плана. <a>Узнать больше</a>',
    tooltip_for_enterprise:
      'MAU — это уникальный пользователь, который обменял хотя бы один токен с Aster в течение расчетного цикла. Неограниченно для План компании.',
  },
  organizations: {
    title: 'Организации',
    tooltip:
