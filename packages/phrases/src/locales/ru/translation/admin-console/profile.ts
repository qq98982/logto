const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        'Удаление вашего аккаунта навсегда удалит все данные о вас в Cloud. Пожалуйста, убедитесь, что у вас есть резервная копия всех важных данных перед продолжением.',
      confirm_information:
    ...
    try_again_later:
      'Пожалуйста, попробуйте позже. Если проблема сохраняется, пожалуйста, свяжитесь с командой Aster с использованием Request ID.',
