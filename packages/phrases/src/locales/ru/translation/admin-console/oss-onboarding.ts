const oss_onboarding = {
  ...
  description:
    'Расскажите немного о себе и своем проекте. Это помогает нам делать Aster лучше для всех.',
  email: {
  ...
  newsletter:
    'Получать обновления продукта, уведомления о безопасности и подборку материалов от Aster.',
  project: {
    label: 'Я использую Aster для',
