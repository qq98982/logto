const user_details = {
  ...
  sessions: {
    title: 'Сессии',
    description:
      'Управление сессиями, поддерживаемыми сервером авторизации Aster. Приостановка сессии Aster здесь предотвращает автоматическое согласие на будущие запросы авторизации.',
    field_name: 'Сессии',
    multiple_signed_in: 'Этот пользователь вошел в несколько устройств или браузеров.',
    not_found:
      'Активные сеансы Aster не найдены. Пользователь в настоящее время не вошел ни на одно устройство.',
    name_column: 'Имя',
  ...
  third_party_apps: {
    ...
    description:
      'Используйте Aster как поставщика удостоверений для авторизации сторонних приложений. Просматривайте и управляйте приложениями, которым этот пользователь предоставил доступ.',
