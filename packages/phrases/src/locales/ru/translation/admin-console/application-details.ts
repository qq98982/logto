...
const application_details = {
  ...
  settings_description:
    '«Приложение» — это зарегистрированное программное обеспечение или сервис, которое может получать доступ к информации пользователя либо действовать от его имени. Приложения помогают узнавать, кто запрашивает какие данные у Aster и обрабатывать вход и разрешения. Заполните необходимые поля для аутентификации.',
  ...
  aster_endpoint: 'Конечная точка Aster',
  application_id: 'ID приложения',
  application_id_tip:
    'Уникальный идентификатор приложения, обычно генерируемый Aster. Он также означает «<a>client_id</a>» в OpenID Connect.',
  ...
  always_issue_refresh_token_label:
    'Включение этой настройки позволит Aster всегда выдавать Refresh Tokens, независимо от того, была ли в запросе на аутентификацию предложена команда `prompt=consent`. Однако данная практика не рекомендуется, если это необходимо, поскольку она несовместима с OpenID Connect и может вызвать проблемы.',
  ...
  rotate_refresh_token_label:
    'При включении Aster будет выдавать новый Refresh Token для запросов токенов, когда пройдет 70% изначального Time to Live (TTL) или будут выполнены определенные условия. <a>Узнать больше</a>',
  rotate_refresh_token_label_for_public_clients:
    'При включении Aster будет выдавать новый Refresh Token для каждого запроса токена. <a>Узнать больше</a>',
  ...
  app_domain_description_1:
    'Не стесняйтесь использовать ваш домен с {{domain}}, под управлением Aster, который имеет постоянную действительность.',
  ...
  third_party_settings_description:
    'Интегрируйте сторонние приложения с Aster в качестве вашего провайдера идентификации (IdP), используя OIDC / OAuth 2.0, с экраном согласия для авторизации пользователя.',
  ...
  permissions: {
    ...
    permission_description_tips:
      'Когда Aster используется в качестве поставщика идентификации (IdP) для аутентификации в сторонних приложениях, и пользователи запрашивают авторизацию, данное описание отображается на экране согласия.',
  ...
  saml_idp_name_id_format: {
    ...
    persistent_description: 'Использовать ID пользователя Aster как идентификатор имени',
    transient: 'Временный',
    transient_description: 'Использовать одноразовый ID пользователя как идентификатор имени',
    unspecified: 'Неопределенный',
    unspecified_description: 'Использовать ID пользователя Aster как идентификатор имени',
  ...
  saml_app_attribute_mapping: {
    ...
    description:
      'Добавьте отображения атрибутов, чтобы синхронизировать профиль пользователя из Aster в ваше приложение.',
    col_aster_claims: 'Значение Aster',
