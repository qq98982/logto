const role = {
  ...
  internal_role_violation:
    'Возможно, вы пытаетесь обновить или удалить внутреннюю роль, что запрещено Aster. Если вы создаете новую роль, попробуйте другое имя, которое не начинается с "#internal:".',
};
