const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'Um inquilino é um ambiente isolado onde você pode gerenciar identidades de usuário, aplicações e todos os outros recursos do Aster.',
    invite_collaborators: 'Convide seus colaboradores por e-mail',
    hear_about_us: {
      title: 'Como você ouviu falar do Aster pela primeira vez?',
      ...
      options: {
        ...
        powered_by: 'Página de login de um aplicativo que usa o Aster',
  ...
  social_callback: {
    ...
    description:
      'Você entrou com sucesso usando sua conta social. Para garantir a integração perfeita e o acesso a todos os recursos do Aster, recomendamos que você prossiga para configurar seu próprio conector social.',
    notice:
