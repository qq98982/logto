const enterprise_sso = {
  ...
  placeholder_description:
    'O Aster forneceu muitos provedores de identidade corporativa integrados para conexão. Ao mesmo tempo, você pode criar o seu próprio com os protocolos SAML e OIDC.',
  create_modal: {
  ...
  basic_info: {
    ...
    saml: {
      ...
      sign_auth_request_tooltip:
        'O Aster assina as solicitações de autenticação SAML com um certificado gerado. Ative apenas se o seu provedor de identidade estiver configurado para verificar solicitações assinadas.',
    ...
    oidc: {
      ...
      redirect_uri_field_custom_domain_description:
        'Se você usa vários <a>domínios personalizados</a> no Aster, lembre-se de adicionar todas as URIs de callback correspondentes ao seu IdP para que o SSO funcione em cada domínio.\n\nO domínio padrão do Aster é sempre válido; inclua-o apenas se também quiser oferecer suporte a SSO nesse domínio.',
    },
  },
  attribute_mapping: {
    ...
    col_sp_claims: 'Valor do provedor de serviços (Aster)',
