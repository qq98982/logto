const concurrent_device_limit = {
  ...
  enable_description:
    'Quando ativado, o Aster impõe o máximo de concessões ativas por usuário para este aplicativo.',
  field: 'Limite de dispositivos simultâneos por aplicativo',
  field_description:
    'Limite quantos dispositivos um usuário pode estar conectado ao mesmo tempo. O Aster impõe isso limitando concessões ativas e revogando automaticamente a concessão mais antiga quando o limite é excedido.',
