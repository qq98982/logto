const usage = {
  ...
  mau: {
    title: 'MAU',
    tooltip:
      'MAU หมายถึงผู้ใช้ที่ไม่ซ้ำกันซึ่งได้แลกเปลี่ยนโทเคนอย่างน้อยหนึ่งครั้งกับ Aster ในรอบบิล ไม่จำกัดสำหรับแผน Pro <a>เรียนรู้เพิ่มเติม</a>',
    tooltip_for_enterprise:
      'MAU หมายถึงผู้ใช้ที่ไม่ซ้ำกันซึ่งได้แลกเปลี่ยนโทเคนอย่างน้อยหนึ่งครั้งกับ Aster ในรอบบิล ไม่จำกัดสำหรับแผน Enterprise',
  },
  organizations: {
    title: 'องค์กร',
    tooltip:
