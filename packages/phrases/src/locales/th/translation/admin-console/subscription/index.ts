...
const subscription = {
  free_plan: 'แผนฟรี',
  free_plan_description: 'สำหรับโปรเจกต์ขนาดเล็กและทดลองใช้ Aster เบื้องต้น ไม่ต้องใช้บัตรเครดิต',
  pro_plan: 'แผน Pro',
  pro_plan_description: 'เหมาะสำหรับธุรกิจที่ต้องการใช้งาน Aster อย่างไร้กังวล',
  ...
  payment_error:
    'พบปัญหาการชำระเงิน ไม่สามารถดำเนินการ ${{price, number}} สำหรับรอบที่แล้ว กรุณาอัปเดตการชำระเงินเพื่อหลีกเลี่ยงการระงับบริการ Aster',
  downgrade: 'ลดระดับ',
  current: 'ปัจจุบัน',
  upgrade: 'อัปเกรด',
  quota_table,
  ...
  not_eligible_modal: {
    ...
    upgrade_description:
      'ตอนนี้คุณใช้งานเกินกว่าที่ <name /> กำหนดไว้แล้ว Aster ได้เปิดตัวอย่างเป็นทางการ พร้อมฟีเจอร์ที่เหมาะสมกับแต่ละแผน ก่อนที่คุณจะอัปเกรดเป็น <name /> กรุณาตรวจสอบเงื่อนไขต่อไปนี้ให้ครบถ้วน',
  ...
  token_usage_notification: {
    ...
    close_to_limit:
      'คุณใกล้จะถึงขีดจำกัดการใช้โทเคนแล้ว Aster จะหยุดออกโทเคนเมื่อการใช้งานเกิน 100% กรุณาอัปเกรดแผนฟรีเพื่อหลีกเลี่ยงปัญหา',
    dev_plan_exceeded: 'เช่าใช้งานนี้ถึงขีดจำกัดโทเคนตามนโยบายขีดจำกัดของ Aster แล้ว',
  },
};
