const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        'การลบบัญชีจะลบข้อมูลทั้งหมดของคุณใน Cloud แบบถาวร กรุณาสำรองข้อมูลสำคัญก่อนดำเนินการ',
      confirm_information:
    ...
    try_again_later:
      'กรุณาลองใหม่อีกครั้งในภายหลัง หากปัญหายังคงอยู่ กรุณาติดต่อทีม Aster พร้อมรหัสคำขอ',
