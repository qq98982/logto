const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'Tenant คือสภาพแวดล้อมที่แยกออกจากกันซึ่งคุณสามารถจัดการข้อมูลตัวตนของผู้ใช้ แอปพลิเคชัน และทรัพยากรอื่น ๆ ของ Aster ได้ทั้งหมด',
    invite_collaborators: 'เชิญผู้ร่วมงานของคุณผ่านอีเมล',
    hear_about_us: {
      title: 'คุณรู้จัก Aster ครั้งแรกจากที่ใด?',
      ...
      options: {
        ...
        powered_by: 'หน้าเข้าสู่ระบบของแอปที่ใช้ Aster',
  ...
  social_callback: {
    ...
    description:
      'คุณได้ลงชื่อเข้าใช้ด้วยบัญชีโซเชียลของคุณเรียบร้อยแล้ว เพื่อการใช้งาน Aster อย่างเต็มประสิทธิภาพและต่อเนื่อง แนะนำให้คุณตั้งค่าตัวเชื่อมต่อโซเชียลของคุณเอง',
    notice:
