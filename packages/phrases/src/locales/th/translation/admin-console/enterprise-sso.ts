const enterprise_sso = {
  ...
  placeholder_description:
    'Aster มีผู้ให้บริการระบุตัวตนสำหรับองค์กรที่มีให้เลือกหลายตัวในระบบ คุณยังสามารถสร้างแบบของคุณเองด้วยโปรโตคอล SAML และ OIDC ได้',
  create_modal: {
  ...
  basic_info: {
    ...
    saml: {
      ...
      sign_auth_request_tooltip:
        'Aster ลงนามคำขอการยืนยันตัวตน SAML ด้วยใบรับรองที่สร้างขึ้น เปิดใช้งานเฉพาะเมื่อผู้ให้บริการข้อมูลประจำตัวของคุณกำหนดค่าให้ตรวจสอบคำขอที่ลงนามแล้วเท่านั้น',
    ...
    oidc: {
      ...
      redirect_uri_field_custom_domain_description:
        'หากคุณใช้ <a>โดเมนแบบกำหนดเอง</a> หลายโดเมนใน Aster อย่าลืมเพิ่ม URI การเรียกกลับที่สอดคล้องกันทั้งหมดลงใน IdP เพื่อให้ SSO ทำงานได้ในทุกโดเมน\n\nโดเมนเริ่มต้นของ Aster ใช้งานได้เสมอ รวมไว้เฉพาะเมื่อคุณต้องการรองรับ SSO ภายใต้โดเมนนั้นด้วย',
    },
  },
  attribute_mapping: {
    ...
    col_sp_claims: 'ค่าของ Service Provider (Aster)',
