const oidc_configs = {
  sessions_card_title: 'เซสชัน Aster',
  sessions_card_description:
    'ปรับแต่งนโยบายเซสชันที่จัดเก็บโดยเซิร์ฟเวอร์การอนุญาตของ Aster โดยจะบันทึกสถานะการยืนยันตัวตนส่วนกลางของผู้ใช้เพื่อเปิดใช้งาน SSO และรองรับการยืนยันตัวตนใหม่แบบเงียบข้ามแอป',
  ...
  cloud_private_key_rotation_notice:
    'ใน Cloud การหมุนเวียนคีย์ส่วนตัวจะมีผลหลังจากช่วงผ่อนผัน 4 ชั่วโมง',
};
