...
const upsell = {
  ...
  create_tenant: {
    ...
    description:
      'Aster มีตัวเลือกแผนราคาที่แข่งขันได้ พร้อมราคานวัตกรรมและเข้าถึงง่าย เหมาะกับบริษัทที่กำลังเติบโต <a>เรียนรู้เพิ่มเติม</a>',
  ...
  mau_exceeded_modal: {
    ...
    notification:
      'MAU ปัจจุบันของคุณเกินขีดจำกัดของ <planName/> โปรดอัปเกรดเป็นแผนพรีเมียมโดยเร็วเพื่อป้องกันการระงับบริการ Aster ',
    update_plan: 'อัปเดตแผน',
  },
  token_exceeded_modal: {
    title: 'การใช้โทเคนเกินขีดจำกัด กรุณาอัปเกรดแผนของคุณ',
    notification:
      'คุณใช้โทเคนของ <planName/> เกินขีดจำกัด ผู้ใช้งานจะไม่สามารถเข้าถึงบริการ Aster ได้ตามปกติ โปรดอัปเกรดเป็นแผนพรีเมียมโดยเร็วเพื่อหลีกเลี่ยงปัญหา',
  },
  payment_overdue_modal: {
    title: 'การชำระบิลล่าช้า',
    notification:
      'ขออภัย! การชำระบิลของผู้เช่า <span>{{name}}</span> ล้มเหลว กรุณาชำระบิลนี้โดยเร็วเพื่อป้องกันการระงับบริการ Aster',
  ...
  charge_notification_for_quota_limit:
    'คุณใช้เกินโควต้าของ {{item}} แล้ว Aster จะคิดค่าบริการที่ใช้เกินจากโควต้าของคุณ คิดค่าบริการจากวันที่เริ่มใช้โมเดลราคา add-on ใหม่ <a>เรียนรู้เพิ่มเติม</a>',
  paywall,
