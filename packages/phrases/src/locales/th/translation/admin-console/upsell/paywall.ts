const paywall = {
  ...
  saml_applications_oss_limit_notice:
    'อินสแตนซ์โอเพนซอร์สของคุณรองรับแอป SAML ได้สูงสุด {{limit}} แอป',
  hooks:
  ...
  third_party_apps:
    'ปลดล็อก Aster สำหรับ third-party apps โดยการอัปเกรดเป็นแผนชำระเงิน หากต้องการความช่วยเหลือ โปรด <a>ติดต่อเรา</a>',
  sso_connectors:
  ...
  branding_customization:
    'อัปเกรดแผนของคุณเพื่อปลดล็อกการควบคุมแบรนด์แบบครบถ้วนด้วยฟีเจอร์ "ซ่อนแบรนด์ Aster" และ "นำ UI ของคุณมาเอง"',
  bring_your_ui:
