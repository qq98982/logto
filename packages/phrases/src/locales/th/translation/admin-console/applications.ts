const applications = {
  ...
  subtitle_with_app_type: 'ตั้งค่าการยืนยันตัวตน Aster สำหรับแอปพลิเคชัน {{name}} ของคุณ',
  ...
  type: {
    ...
    protected: {
      ...
      subtitle: 'แอปที่ได้รับการป้องกันโดย Aster',
  ...
  placeholder_description:
    'Aster ใช้เอนทิตีแอปพลิเคชันสำหรับ OIDC เพื่อช่วยในงานต่าง ๆ เช่น การระบุแอป การจัดการการเข้าสู่ระบบ และสร้างบันทึกการตรวจสอบ',
  third_party_application_placeholder_description:
    'ใช้ Aster เป็นผู้ให้บริการระบุตัวตนเพื่อให้การอนุญาต OAuth แก่บริการของบุคคลที่สาม \n รวมถึงหน้าจอขอความยินยอมของผู้ใช้ที่สร้างไว้ล่วงหน้าสำหรับการเข้าถึงทรัพยากร <a>เรียนรู้เพิ่มเติม</a>',
  guide: {
    third_party: {
      title: 'ผสานรวมแอปพลิเคชันของบุคคลที่สาม',
      description:
        'ใช้ Aster เป็นผู้ให้บริการข้อมูลประจำตัวเพื่อให้การอนุญาต OAuth แก่บริการของบุคคลที่สาม พร้อมหน้าจอขอความยินยอมของผู้ใช้ที่สร้างไว้ล่วงหน้าเพื่อการเข้าถึงทรัพยากรอย่างปลอดภัย <a>เรียนรู้เพิ่มเติม</a>',
    },
  },
};
