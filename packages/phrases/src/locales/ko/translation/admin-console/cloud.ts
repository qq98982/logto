const cloud = {
  ...
  create_tenant: {
    ...
    title: '첫 번째 테넌트 만들기',
    description:
      '테넌트는 사용자 신원, 애플리케이션 및 기타 모든 Aster 리소스를 관리할 수 있는 독립된 환경입니다.',
    invite_collaborators: '이메일로 협력자를 초대하세요',
    hear_about_us: {
      title: 'Aster를 처음 어떻게 알게 되었나요?',
      ...
      options: {
        ...
        powered_by: 'Aster를 사용하는 앱의 로그인 페이지',
  ...
  social_callback: {
    title: '성공적으로 로그인했어요',
    description:
      '소셜 계정을 사용하여 로그인에 성공했어요. Aster의 모든 기능을 원활하게 통합하고 접근하려면 당신의 소셜 연동을 구성하는 것이 좋습니다.',
    notice:
