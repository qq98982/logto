const paywall = {
  ...
  saml_applications_oss_limit_notice:
    '오픈 소스 인스턴스는 최대 {{limit}}개의 SAML 애플리케이션을 지원합니다.',
  hooks:
  ...
  third_party_apps:
    'Aster를 IdP로서 타사 앱에 대해 잠금 해제하려면 유료 플랜으로 업그레이드하세요. 도움이 필요하면 <a>문의하세요</a>.',
  sso_connectors:
  ...
  branding_customization:
    '플랜을 업그레이드하여 "Aster 브랜딩 숨기기"과 "UI 가져오기" 기능으로 브랜드를 완전히 제어하세요.',
