...
const upsell = {
  ...
  create_tenant: {
    title: '테넌트 플랜 선택하기',
    description:
      'Aster는 성장 중인 기업을 위해 혁신적이고 저렴한 가격으로 디자인된 경쟁력 있는 플랜 옵션을 제공합니다. <a>더 알아보기</a>',
    base_price: '기본 가격',
  ...
  mau_exceeded_modal: {
    ...
    notification:
      '현재 MAU가 <planName/>의 한도를 초과했습니다. Aster 서비스 중단을 피하기 위해 프리미엄으로 플랜을 업그레이드하세요.',
    update_plan: '플랜 업데이트',
  },
  token_exceeded_modal: {
    title: '토큰 사용량이 한도를 초과했습니다. 플랜을 업그레이드하세요.',
    notification:
      '현재 <planName/>의 토큰 사용 한도를 초과했습니다. 사용자들이 Aster 서비스를 제대로 이용할 수 없습니다. 불편을 피하기 위해 즉시 프리미엄으로 플랜을 업그레이드하십시오.',
  },
  payment_overdue_modal: {
    title: '청구서 지불 연체',
    notification:
      '이런! 테넌트 <span>{{name}}</span>의 청구서 결제에 실패했습니다. Aster 서비스 중단을 피하기 위해 즉시 청구서를 지불하십시오.',
    unpaid_bills: '미납 청구서',
  ...
  charge_notification_for_quota_limit:
    '{{item}} 할당량 한도를 초과했습니다. Aster는 할당량을 초과하는 사용에 대한 요금을 추가합니다. 새로운 애드온 가격 디자인이 출시된 날부터 청구가 시작됩니다. <a>더 알아보기</a>',
  paywall,
