const api_resource_details = {
  ...
  management_api_settings_description:
    'Aster 관리 API는 관리자가 다양한 ID 관련 작업을 관리하고 보안 정책을 시행하며 규정 및 표준을 준수할 수 있도록 하는 포괄적인 API 컬렉션입니다.',
  management_api_notice:
    '이 API는 Aster 엔터티를 나타내며 수정 또는 삭제할 수 없습니다. Aster 관리 API를 호출하려면 머신 투 머신 앱을 만드십시오. <a>자세히 알아보기</a>',
