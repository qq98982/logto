...
const upsell = {
  ...
  create_tenant: {
    title: '选择您的租户计划',
    description:
      'Aster 提供创新且经济实惠的定价计划，旨在为不断发展的公司提供竞争优势。 <a>了解更多</a>',
    base_price: '基础价格',
  ...
  mau_exceeded_modal: {
    ...
    notification:
      '您当前的 MAU 已超过<planName/>的限制。请立即升级到高级计划，以避免 Aster 服务的暂停。',
    update_plan: '更新计划',
  },
  token_exceeded_modal: {
    title: '令牌使用超过限制。升级你的计划。',
    notification:
      '你已超出<planName/>令牌使用限制。用户将无法正常访问 Aster 服务。请及时升级你的计划到高级版，以避免任何不便。',
  },
  payment_overdue_modal: {
    title: '账单逾期未付',
    notification:
      '糟糕！租户<span>{{name}}</span>的账单支付失败。请尽快支付账单，以避免Aster服务中止。',
    unpaid_bills: '未付账单',
    update_payment: '更新支付',
  },
  add_on_quota_item: {
  ...
  charge_notification_for_quota_limit:
    '您已超过{{item}}配额限制。Aster将为超出配额限制的使用添加费用。计费将从新的附加定价设计发布当天开始。 <a>了解更多</a>',
  paywall,
