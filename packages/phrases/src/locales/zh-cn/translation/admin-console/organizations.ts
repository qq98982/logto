  ...
  guide: {
    ...
    introduction: {
      ...
      section_2: {
        ...
        description:
          '在多租户 SaaS 应用程序中，多个组织通常共享相同的访问控制模板，包括权限和角色。在 Aster 中，我们称之为“组织模板”。',
      ...
      section_3: {
        ...
        description:
          '是的，您可以将 API 权限分配给组织角色。Aster 提供灵活性，有效管理您组织的角色，允许您在这些角色中包括组织权限和 API 权限。',
      },
      section_4: {
        title: '交互插图以查看所有关系',
        description:
