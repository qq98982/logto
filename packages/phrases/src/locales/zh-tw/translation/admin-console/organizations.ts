  ...
  guide: {
    ...
    introduction: {
      ...
      section_2: {
        ...
        description:
          '在多租戶SaaS應用程式中，多個組織通常共用相同的存取控制模板，其中包括權限和角色。 在Aster中，我們稱之為「組織模板」。',
      ...
      section_3: {
        ...
        description:
          '是的，你可以將 API 權限指派給組織角色。 Aster 提供彈性，有效管理你組織的角色，允許你在這些角色中包含組織權限和 API 權限。',
      },
      section_4: {
