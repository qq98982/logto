...
const upsell = {
  ...
  token_exceeded_modal: {
    ...
    notification:
      '你已超出<planName/>的 Token 使用限制。用戶將無法正常訪問 Aster 服務。請及時升級你的計劃至高級，以避免任何不便。',
  },
  payment_overdue_modal: {
    title: '賬單逾期未付',
    notification:
      '糟糕！租戶<span>{{name}}</span>的賬單支付失敗。請儘快支付賬單，以避免 Aster 服務中止。',
    unpaid_bills: '未付賬單',
    update_payment: '更新支付',
  },
  add_on_quota_item: {
  ...
  charge_notification_for_quota_limit:
    '您已超出{{item}}配額限制。Aster 將為超出配額限制的使用添加費用。計費將從新的附加定價設計發布當天開始。 <a>了解更多</a>',
  paywall,
