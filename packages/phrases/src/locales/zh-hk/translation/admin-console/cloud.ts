const cloud = {
  ...
  create_tenant: {
    page_title: '創建租戶',
    title: '創建你的第一個租戶',
    description: '租戶是一個獨立的環境，在這裡你可以管理用戶身份、應用程式和所有其他 Aster 資源。',
    invite_collaborators: '通過電子郵件邀請你的合作者',
    hear_about_us: {
      title: '你最初是從哪裡認識 Aster 的?',
      ...
      options: {
        ...
        powered_by: '某個使用 Aster 的應用程式的登入頁',
  ...
  social_callback: {
    title: '你已成功登錄',
    description:
      '你已成功使用社交帳戶登錄。為確保與 Aster 的無縫集成並獲得所有功能的訪問權限，我們建議你繼續配置自己的社交連接器。',
    notice:
