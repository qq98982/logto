...
const application_details = {
  ...
  settings_description:
    "Un'applicazione è un software o un servizio registrato che può accedere alle informazioni dell'utente o agire per suo conto. Le applicazioni aiutano Aster a riconoscere chi sta richiedendo cosa e gestiscono l'accesso e le autorizzazioni. Compila i campi obbligatori per l'autenticazione.",
  ...
  application_id_tip:
    'L\'identificatore univoco dell\'applicazione generato normalmente da Aster. Sta anche per "<a>client_id</a>" in OpenID Connect.',
  ...
  always_issue_refresh_token_label:
    'Abilitando questa configurazione, Aster potrà rilasciare sempre token di aggiornamento, anche se `prompt=consent` non viene presentata nella richiesta di autenticazione. Tuttavia, questa pratica è scoraggiata a meno che non sia necessaria, in quanto non è compatibile con OpenID Connect e potrebbe potenzialmente causare problemi.',
  ...
  rotate_refresh_token_label:
    'Quando abilitato, Aster emetterà un nuovo token di aggiornamento per le richieste di token quando è passato il 70% del Tempo di vita (TTL) originale o sono soddisfatte determinate condizioni. <a>Ulteriori informazioni</a>',
  rotate_refresh_token_label_for_public_clients:
    'Quando abilitato, Aster emetterà un nuovo token di aggiornamento per ogni richiesta di token. <a>Ulteriori informazioni</a>',
  ...
  app_domain_description_1:
    'Sentiti libero di utilizzare il tuo dominio con {{domain}} alimentato da Aster, che è permanentemente valido.',
  ...
  third_party_settings_description:
    "Integra applicazioni di terze parti con Aster come tuo Identity Provider (IdP) utilizzando OIDC / OAuth 2.0, con uno schermo di consenso per l'autorizzazione dell'utente.",
  ...
  permissions: {
    ...
    permission_description_tips:
      "Quando Aster viene utilizzato come Provider di Identità (IdP) per l'autenticazione nelle app di terze parti e agli utenti viene chiesta l'autorizzazione, questa descrizione appare sullo schermo del consenso.",
    user_title: 'Utente',
    user_description:
  ...
  saml_idp_name_id_format: {
    ...
    persistent_description: "Usa l'ID utente Aster come Name ID",
    transient: 'Transitorio',
    transient_description: 'Usa un ID utente una tantum come Name ID',
    unspecified: 'Non specificato',
    unspecified_description: "Usa l'ID utente Aster come Name ID",
  ...
  saml_app_attribute_mapping: {
    ...
    description:
      'Aggiungi mappature di attributi per sincronizzare il profilo utente da Aster alla tua applicazione.',
    col_aster_claims: 'Valore di Aster',
