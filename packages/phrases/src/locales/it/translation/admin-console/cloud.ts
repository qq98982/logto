const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'Un tenant è un ambiente isolato in cui puoi gestire identità degli utenti, applicazioni e tutte le altre risorse di Aster.',
    invite_collaborators: 'Invita i tuoi collaboratori via email',
    hear_about_us: {
      title: 'Come hai sentito parlare di Aster per la prima volta?',
      ...
      options: {
        ...
        powered_by: "Pagina di accesso di un'app che utilizza Aster",
  ...
  social_callback: {
    ...
    description:
      "Hai effettuato l'accesso con successo utilizzando il tuo account social. Per garantire integrazione senza problemi e accesso a tutte le funzionalità di Aster, ti consigliamo di procedere alla configurazione del tuo connettore social.",
    notice:
