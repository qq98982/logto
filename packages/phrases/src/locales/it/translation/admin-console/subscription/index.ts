...
const subscription = {
  ...
  free_plan_description:
    'Per progetti secondari e prove iniziali di Aster. Nessuna carta di credito.',
  pro_plan: 'Piano Pro',
  pro_plan_description: 'Per aziende che beneficiano di Aster senza preoccupazioni.',
  ...
  payment_error:
    'Rilevato un problema di pagamento. Impossibile elaborare ${{price, number}} per il ciclo precedente. Aggiorna il pagamento per evitare la sospensione del servizio Aster.',
  downgrade: 'Degrado',
  current: 'Attuale',
  ...
  not_eligible_modal: {
    ...
    upgrade_description:
      "Attualmente stai utilizzando più di quanto consentito da <name />. Aster è ora ufficiale, con funzionalità personalizzate per ciascun piano. Prima di considerare l'aggiornamento al <name />, assicurati di soddisfare i seguenti criteri prima dell'aggiornamento.",
  ...
  token_usage_notification: {
    ...
    close_to_limit:
      'Stai quasi raggiungendo il limite di utilizzo del tuo token. Aster smetterà di concedere token se il tuo utilizzo supera il 100%. Si prega di aggiornare il piano gratuito per evitare inconvenienti.',
    dev_plan_exceeded:
      'Questo tenant ha raggiunto il limite di token per la politica del limite di entità di Aster.',
  },
};
