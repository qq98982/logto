const oidc_configs = {
  sessions_card_title: 'Sessioni Aster',
  sessions_card_description:
    "Personalizza la policy di sessione archiviata dal server di autorizzazione Aster. Registra lo stato di autenticazione globale dell'utente per abilitare l'SSO e consentire la riautenticazione silenziosa tra le app.",
  ...
  cloud_private_key_rotation_notice:
    'In Cloud, la rotazione delle chiavi private ha effetto dopo un periodo di grazia di 4 ore.',
};
