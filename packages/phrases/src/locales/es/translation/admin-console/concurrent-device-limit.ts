const concurrent_device_limit = {
  ...
  enable_description:
    'Cuando está habilitado, Aster aplica el máximo de concesiones activas por usuario para esta aplicación.',
  field: 'Límite de dispositivos concurrentes por aplicación',
  field_description:
    'Limita cuántos dispositivos puede tener un usuario conectados al mismo tiempo. Aster aplica esto limitando las concesiones activas y revoca automáticamente la concesión más antigua cuando se excede el límite.',
