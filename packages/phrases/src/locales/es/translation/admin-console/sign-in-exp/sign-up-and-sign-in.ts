const sign_up_and_sign_in = {
  ...
  social_sign_in: {
    ...
    automatic_account_linking_tip:
      'Cuando está habilitado, si un usuario inicia sesión con una nueva identidad social y existe exactamente una cuenta con el mismo identificador (por ejemplo, una dirección de correo electrónico), Aster vinculará automáticamente la identidad social a esa cuenta. No se le pedirá al usuario que elija si desea vincular cuentas.',
