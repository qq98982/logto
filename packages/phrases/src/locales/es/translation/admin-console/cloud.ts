const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'Un inquilino es un entorno aislado donde puedes gestionar identidades de usuarios, aplicaciones y todos los demás recursos de Aster.',
    invite_collaborators: 'Invita a tus colaboradores por correo electrónico',
    hear_about_us: {
      title: '¿Cómo conociste Aster por primera vez?',
      ...
      options: {
        ...
        powered_by: 'Página de inicio de sesión de una aplicación que usa Aster',
  ...
  social_callback: {
    ...
    description:
      'Ha iniciado sesión correctamente utilizando su cuenta social. Para garantizar una integración perfecta y el acceso a todas las funciones de Aster, recomendamos que proceda a configurar su propio conector social.',
    notice:
