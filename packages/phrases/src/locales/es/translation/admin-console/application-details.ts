...
const application_details = {
  ...
  settings_description:
    'Una "aplicación" es un software o servicio registrado que puede acceder a la información del usuario o actuar en su nombre. Las aplicaciones ayudan a Aster a reconocer quién solicita qué y gestionan el inicio de sesión y los permisos. Completa los campos obligatorios para la autenticación.',
  ...
  aster_endpoint: 'Endpoint de Aster',
  application_id: 'ID de Aplicación',
  application_id_tip:
    'El identificador de aplicación único normalmente generado por Aster. También se conoce como “<a>client_id</a>” en OpenID Connect.',
  ...
  always_issue_refresh_token_label:
    'Al habilitar esta configuración, Aster siempre emitirá Tokens de Refresco, independientemente de si se presenta o no “prompt=consent” en la solicitud de autenticación. Sin embargo, esta práctica no está recomendada a menos que sea necesario, ya que no es compatible con OpenID Connect y puede causar problemas potenciales.',
  ...
  rotate_refresh_token_label:
    'Cuando está habilitado, Aster emitirá un nuevo token de refresco para las solicitudes de token cuando ha pasado el 70 % del tiempo de vida útil (TTL) original o se cumplen ciertas condiciones. <a>Más información</a>',
  rotate_refresh_token_label_for_public_clients:
    'Cuando está habilitado, Aster emitirá un nuevo token de refresco para cada solicitud de token. <a>Más información</a>',
  ...
  app_domain_description_1:
    'No dudes en utilizar tu dominio con {{domain}} potenciado por Aster, que es permanentemente válido.',
  ...
  third_party_settings_description:
    'Integra aplicaciones de terceros con Aster como tu Proveedor de Identidad (IdP) usando OIDC / OAuth 2.0, con una pantalla de consentimiento para la autorización del usuario.',
  ...
  permissions: {
    ...
    permission_description_tips:
      'Cuando Aster es utilizado como un Proveedor de Identidad (IdP) para autenticación en aplicaciones de terceros, y se solicita autorización a los usuarios, esta descripción aparece en la pantalla de consentimiento.',
    user_title: 'Usuario',
    user_description:
  ...
  saml_idp_name_id_format: {
    ...
    persistent_description: 'Usar el ID de usuario de Aster como ID de Nombre',
    transient: 'Transitorio',
    transient_description: 'Usar un ID de usuario de una sola vez como ID de Nombre',
    unspecified: 'No especificado',
    unspecified_description: 'Usar el ID de usuario de Aster como ID de Nombre',
  ...
  saml_app_attribute_mapping: {
    ...
    description:
      'Añade mapeo de atributos para sincronizar el perfil de usuario desde Aster a tu aplicación.',
    col_aster_claims: 'Valor de Aster',
