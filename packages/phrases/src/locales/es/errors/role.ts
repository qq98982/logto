const role = {
  ...
  internal_role_violation:
    'Tal vez esté intentando actualizar o eliminar un rol interno lo cual es prohibido por Aster. Si está creando un nuevo rol, intente con otro nombre que no empiece con "#internal:".',
};
