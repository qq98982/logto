const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'Ein Mandant ist eine isolierte Umgebung, in der Sie Benutzeridentitäten, Anwendungen und alle anderen Aster-Ressourcen verwalten können.',
    invite_collaborators: 'Laden Sie Ihre Mitarbeiter per E-Mail ein',
    hear_about_us: {
      title: 'Wie haben Sie zum ersten Mal von Aster erfahren?',
      ...
      options: {
        ...
        powered_by: 'Anmeldeseite einer App, die Aster verwendet',
  ...
  social_callback: {
    ...
    description:
      'Sie haben sich erfolgreich mit Ihrem Social-Account angemeldet. Um eine nahtlose Integration und den Zugriff auf alle Funktionen von Aster zu gewährleisten, empfehlen wir Ihnen, Ihren eigenen Social-Connector zu konfigurieren.',
    notice:
