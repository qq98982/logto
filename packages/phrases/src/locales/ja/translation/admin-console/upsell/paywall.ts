const paywall = {
  ...
  saml_applications_oss_limit_notice:
    'オープンソース版のインスタンスでは、最大 {{limit}} 個の SAML アプリケーションを利用できます。',
  hooks:
  ...
  third_party_apps:
    '有料プランにアップグレードして、サードパーティアプリの IdP としてAsterを解除します。サポートが必要な場合はお気軽に<a>お問い合わせ</a>ください。',
  sso_connectors:
  ...
  branding_customization:
    'プランをアップグレードして、「Hide Aster branding」と「Bring your UI」機能でブランド管理を完全にコントロールしましょう。',
  bring_your_ui:
