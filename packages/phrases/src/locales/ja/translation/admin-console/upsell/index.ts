...
const upsell = {
  ...
  token_exceeded_modal: {
    ...
    notification:
      '<planName/> のトークン使用制限を超えました。ユーザーは Aster サービスに正しくアクセスできません。ご不便をおかけしないよう、すぐにプレミアムプランにアップグレードしてください。',
  },
  payment_overdue_modal: {
    title: '請求書の支払いが期限切れです',
    notification:
      'おっと！テナント<span>{{name}}</span>の請求書の支払いが失敗しました。Asterサービスの停止を避けるために、すみやかに請求書をお支払いください。',
  ...
  charge_notification_for_quota_limit:
    '{{item}} のクォータ制限を超えています。Aster はクォータ制限を超える利用に対して料金を追加します。新しいアドオン価格設計がリリースされる日から請求が開始されます。 <a>詳細</a>',
  paywall,
