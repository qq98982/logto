const usage = {
  ...
  mau: {
    title: 'MAU',
    tooltip:
      'MAU は、請求サイクル内で Aster と少なくとも 1 つのトークンを交換したユニーク ユーザーです。Pro プランでは無制限です。<a>さらに詳しく</a>',
    tooltip_for_enterprise:
      'MAU は、請求サイクル内で Aster と少なくとも 1 つのトークンを交換したユニーク ユーザーです。エンタープライズ プランでは無制限です。',
  },
  organizations: {
    title: '組織',
    tooltip:
