const user_details = {
  ...
  sessions: {
    title: 'セッション',
    description:
      'Aster 認可サーバーによって維持されるセッションを管理します。ここで Aster セッションを取り消すと、今後の認可リクエストでの自動同意が防止されます。',
    field_name: 'セッション',
    multiple_signed_in: 'このユーザーは複数のデバイスまたはブラウザにサインインしています。',
    not_found:
      'アクティブな Aster セッションが見つかりません。ユーザーは現在どのデバイスにもサインインしていません。',
    name_column: '名前',
  ...
  third_party_apps: {
    title: 'サードパーティアプリ',
    description:
      'Aster を ID プロバイダーとして利用し、サードパーティアプリを認可します。このユーザーがアクセスを許可したアプリを表示して管理します。',
