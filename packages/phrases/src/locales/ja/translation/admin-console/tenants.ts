const tenants = {
  ...
  settings: {
    ...
    tenant_instance_description:
      'テナントをホストする場所を選択してください。パブリック共有インフラストラクチャの Cloud を選択するか、専用リソース用のプライベートインスタンスを選択します。',
    ...
    enterprise_sso_description:
      '有料プランで利用可能です。お問い合わせいただくと、すべてのメンバーが組織のアイデンティティプロバイダーを使用して Cloud コンソールにサインインできるようになります。',
  },
  full_env_tag: {
    development: '開発',
    production: '本番',
  ...
  create_modal: {
    ...
    tenant_id_tip:
      'テナントIDをカスタマイズします。空のままにすると、Asterがデフォルトのidを生成します。テナントIDは作成後に変更できません。',
  },
  ...
  tenant_landing_page: {
    ...
    description:
      'Aster でプロジェクトを設定するには、新しいテナントを作成してください。ログアウトまたはアカウントを削除する必要がある場合は、右上隅のアバターボタンをクリックしてください。',
