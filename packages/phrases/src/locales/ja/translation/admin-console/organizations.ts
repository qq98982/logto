const organizations = {
  ...
  guide: {
    ...
    introduction: {
      title: 'Aster で組織がどのように機能するかを理解しましょう',
      section_1: {
      ...
      section_2: {
        ...
        description:
          'マルチテナント SaaS アプリケーションでは、複数の組織がしばしば同じアクセス制御テンプレートを共有します。これには権限や役割が含まれます。Aster ではこれを「組織テンプレート」と呼びます。',
      ...
      section_3: {
        ...
        description:
          'はい、組織の役割に API 権限を割り当てることができます。 Aster は組織の役割を効果的に管理する柔軟性を提供し、それらの役割に組織権限と API 権限の両方を含めることができます。',
      },
      section_4: {
