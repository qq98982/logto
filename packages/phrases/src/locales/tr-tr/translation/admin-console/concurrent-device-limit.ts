const concurrent_device_limit = {
  ...
  enable_description:
    'Etkinleştirildiğinde, Aster bu uygulama için kullanıcı başına maksimum aktif izinleri zorlar.',
  field: 'Uygulama başına eşzamanlı cihaz sınırı',
  field_description:
    'Bir kullanıcının aynı anda kaç cihazda oturum açabileceğini sınırlayın. Aster, aktif izinleri sınırlayarak bunu zorlar ve sınır aşıldığında en eski izni otomatik olarak iptal eder.',
