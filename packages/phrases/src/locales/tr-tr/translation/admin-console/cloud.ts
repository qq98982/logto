const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'Bir kiracı, kullanıcı kimliklerini, uygulamaları ve diğer tüm Aster kaynaklarını yönetebileceğiniz izole bir ortamdır.',
    invite_collaborators: 'E-posta ile işbirlikçilerinizi davet edin',
    hear_about_us: {
      title: "Aster'i ilk nereden duydunuz?",
      ...
      options: {
        ...
        powered_by: 'Aster kullanan bir uygulamanın oturum açma sayfası',
  ...
  social_callback: {
    ...
    description:
      "Sosyal hesabınızı kullanarak başarılı bir şekilde giriş yaptınız. Aster'in tüm özelliklerine sorunsuz entegrasyon ve erişim sağlamak için kendi sosyal konektörünüzü yapılandırmaya devam etmenizi öneririz.",
    notice:
