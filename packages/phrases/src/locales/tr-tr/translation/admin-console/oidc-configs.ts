const oidc_configs = {
  sessions_card_title: 'Aster oturumları',
  sessions_card_description:
    'Aster yetkilendirme sunucusunda saklanan oturum politikasını özelleştirin. Kullanıcının genel kimlik doğrulama durumunu kaydeder; böylece SSO etkinleşir ve uygulamalar arasında sessiz yeniden kimlik doğrulama sağlanır.',
