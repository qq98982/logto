const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'Um inquilino é um ambiente isolado onde pode gerir identidades de utilizadores, aplicações e todos os demais recursos da Aster.',
    invite_collaborators: 'Convide os seus colaboradores por email',
    hear_about_us: {
      title: 'Como ouviu falar da Aster pela primeira vez?',
      ...
      options: {
        ...
        powered_by: 'Página de início de sessão de uma aplicação que usa a Aster',
  ...
  social_callback: {
    ...
    description:
      'Entrou com sucesso usando a sua conta social. Para garantir uma integração perfeita e acesso a todos os recursos da Aster, recomendamos que prossiga para configurar o seu próprio conector social.',
    notice:
