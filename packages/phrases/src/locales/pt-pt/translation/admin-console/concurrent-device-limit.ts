const concurrent_device_limit = {
  ...
  enable_description:
    'Quando ativada, Aster aplica o máximo de concessões ativas por utilizador para esta aplicação.',
  field: 'Limite de dispositivos concorrentes por aplicação',
  field_description:
    'Limite quantos dispositivos um utilizador pode estar conectado ao mesmo tempo. Aster aplica este limite restringindo concessões ativas e revogando automaticamente a concessão mais antiga quando o limite é excedido.',
