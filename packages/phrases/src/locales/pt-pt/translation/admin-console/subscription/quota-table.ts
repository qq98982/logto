const quota_table = {
  ...
  mau_tip:
    'MAU (utilizadores ativos mensais) significa o número de utilizadores únicos que trocaram pelo menos um token com o Aster num ciclo de faturação.',
  tokens_tip:
    'Todos os tipos de tokens emitidos pelo Aster, incluindo token de acesso, token de atualização, etc.',
  mao_tip:
  ...
  third_party_tip:
    'Utilize o Aster como o seu fornecedor de identidade OIDC para inícios de sessão de aplicações de terceiros e outorga de permissões.',
