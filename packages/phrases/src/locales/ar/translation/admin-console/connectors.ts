const connectors = {
  ...
  placeholder_description:
    'قدمت Aster العديد من موصلات تسجيل الدخول بواسطة وسائل التواصل الاجتماعي المستخدمة على نطاق واسع في الوقت الحالي يمكنك إنشاء موصل خاص بك باستخدام بروتوكولات قياسية.',
  ...
  guide: {
    ...
    target_tooltip:
      'يشير "اسم مزود الهوية" في موصلات Aster الاجتماعية إلى "المصدر" لهوياتك الاجتماعية. في تصميم Aster ، لا نقبل نفس "اسم مزود الهوية" لمنصة محددة لتجنب التعارضات. يجب أن تكون حذرًا جدًا قبل إضافة موصل لأنه لا يمكنك تغيير قيمته بمجرد إنشائه. <a>تعلم المزيد</a>',
    target_conflict:
    ...
    callback_uri_custom_domain_description:
      'إذا كنت تستخدم عدة <a>نطاقات مخصصة</a> في Aster، فتأكد من إضافة جميع عناوين URI لرد الاتصال المقابلة إلى موفر الهوية لديك لضمان عمل تسجيل الدخول الاجتماعي عبر كل نطاق.\n\nيظل نطاق Aster الافتراضي صالحًا دائمًا؛ قم بتضمينه فقط إذا كنت ترغب أيضًا في دعم تسجيلات الدخول تحت ذلك النطاق.',
