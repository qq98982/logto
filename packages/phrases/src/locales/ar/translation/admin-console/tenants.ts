const tenants = {
  ...
  settings: {
    ...
    tenant_instance_description:
      'اختر المكان الذي سيتم استضافة المستأجر الخاص بك فيه. اختر Cloud للبنية التحتية العامة المشتركة ، أو مثيل خاص للحصول على موارد مخصصة.',
    ...
    enterprise_sso_description:
      'متاح في الخطط المدفوعة. اتصل بنا لتمكين Enterprise SSO حتى يتمكن جميع الأعضاء من تسجيل الدخول إلى Cloud Console باستخدام موفر هوية مؤسستك.',
  },
  full_env_tag: {
    development: 'تطوير',
    production: 'إنتاج',
  ...
  create_modal: {
    ...
    tenant_id_tip:
      'قم بتخصيص معرف المستأجر. إذا ترك فارغًا، سيقوم Aster بإنشاء معرف افتراضي. لا يمكن تغيير معرف المستأجر بعد الإنشاء.',
  },
  ...
  tenant_landing_page: {
    ...
    description:
      'لبدء تكوين مشروعك باستخدام Aster ، يرجى إنشاء مستأجر جديد. إذا كنت بحاجة إلى تسجيل الخروج أو حذف حسابك ، فقط انقر فوق زر الصورة الرمزية في الزاوية اليمنى العلوية.',
