const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        'سيؤدي حذف حسابك إلى إزالة جميع البيانات المتعلقة بك في Cloud. لذا يرجى التأكد من نسخ أي بيانات مهمة قبل المتابعة.',
      confirm_information:
    ...
    try_again_later:
      'يرجى المحاولة مرة أخرى في وقت لاحق. إذا استمرت المشكلة ، يرجى الاتصال بفريق Aster مع معرف الطلب.',
