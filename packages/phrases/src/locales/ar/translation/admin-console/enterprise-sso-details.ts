const enterprise_sso_details = {
  ...
  service_provider_property_description:
    'قم بإعداد تكامل التطبيق باستخدام {{protocol}} في موفر الهوية الخاص بك. أدخل التفاصيل المقدمة من قِبل Aster.',
  attribute_mapping_title: 'تعيينات السمات',
  attribute_mapping_description:
    'قم بمزامنة ملفات تعريف المستخدمين من موفر الهوية عن طريق تكوين تعيين السمات للمستخدم إما على جانب موفر الهوية أو جانب Aster.',
  saml_preview: {
  ...
  idp_initiated_auth_config: {
    ...
    redirect_uri_tooltip:
      'URI إعادة التوجيه لإعادة توجيه المستخدمين بعد تسجيل الدخول بنجاح. سوف يستخدم Aster هذا URI كـ OIDC URI إعادة التوجيه في طلب التفويض. استخدم URI مخصص لتدفق مصادقة SSO الذي يبدأ من IdP لمزيد من الأمان.',
  ...
  trust_unverified_email_tip:
    'موصل Entra ID (OIDC) لا يقدم المطالبة `email_verified`، مما يعني أن عناوين البريد الإلكتروني من Azure ليست مضمونة التحقق. بشكل افتراضي، لن يقوم Aster بمزامنة عناوين البريد الإلكتروني غير الموثوقة إلى ملف تعريف المستخدم. قم بتفعيل هذا الخيار فقط إذا كنت تثق في جميع عناوين البريد الإلكتروني من دليل Entra ID.',
  trust_unverified_email_tip_oidc:
    'قد لا يعيد موصل OIDC مطالبة `email_verified`، مما يعني أن عناوين البريد الإلكتروني من موفر الهوية قد لا تكون مضمونة التحقق. بشكل افتراضي، لن يقوم Aster بمزامنة عناوين البريد الإلكتروني غير المُحقَّقة إلى ملف تعريف المستخدم. فعّل هذا الخيار فقط إذا كنت تثق بجميع عناوين البريد الإلكتروني من موفر الهوية.',
  offline_access: {
