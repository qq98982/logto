const oss_onboarding = {
  ...
  description: 'أخبرنا قليلًا عنك وعن مشروعك. يساعدنا ذلك على بناء Aster أفضل للجميع.',
  email: {
    label: 'البريد الإلكتروني',
    description: 'سنستخدم هذا العنوان إذا احتجنا إلى التواصل معك بشأن حسابك.',
    placeholder: 'email@example.com',
  },
  newsletter: 'تلقي تحديثات المنتج والتنبيهات الأمنية والمحتوى المختار من Aster.',
  project: {
    label: 'أستخدم Aster من أجل',
    personal: 'مشروع شخصي',
    company: 'مشروع شركة',
  },
  project_name: {
