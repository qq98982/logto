const applications = {
  ...
  subtitle_with_app_type: 'قم بإعداد مصادقة Aster لتطبيقك {{name}}',
  ...
  type: {
    ...
    protected: {
      title: 'تطبيق محمي',
      subtitle: 'تطبيق محمي بواسطة Aster',
  ...
  placeholder_description:
    'يستخدم Aster كيان التطبيق لـ OIDC للمساعدة في مهام مثل تحديد التطبيقات الخاصة بك وإدارة تسجيل الدخول وإنشاء سجلات التدقيق.',
  third_party_application_placeholder_description:
    'استخدم Aster كمزود هوية لتوفير تفويض OAuth للخدمات الخارجية. \n يتضمن شاشة موافقة المستخدم المُبنية مسبقًا للوصول إلى الموارد. <a>اعرف المزيد</a>',
  guide: {
    third_party: {
      title: 'دمج تطبيق جهة خارجية',
      description:
        'استخدم Aster كمزوّد هوية لتوفير تفويض OAuth لخدمات الجهات الخارجية. يتضمن شاشة موافقة مستخدم مُعدّة مسبقًا للوصول الآمن إلى الموارد. <a>معرفة المزيد</a>',
    },
  },
};
