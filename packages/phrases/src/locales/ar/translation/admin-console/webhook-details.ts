const webhook_details = {
  ...
  settings: {
    ...
    events: 'الأحداث',
    events_description: 'حدد الأحداث المشغلة التي سترسل Aster طلب POST لها.',
    name: 'الاسم',
    endpoint_url: 'عنوان URL النهائي',
    signing_key: 'مفتاح التوقيع',
    signing_key_tip:
      'أضف المفتاح السري الذي يوفره Aster إلى عنوان URL الخاص بك كرأس طلب لضمان صحة حمولة الويب هوك.',
