const user_details = {
  ...
  sessions: {
    title: 'الجلسات',
    description:
      'إدارة الجلسات التي تحتفظ بها خادم التفويض Aster. إلغاء جلسة Aster هنا يمنع الموافقة التلقائية على طلبات التفويض المستقبلية.',
    field_name: 'الجلسات',
    multiple_signed_in: 'قام هذا المستخدم بتسجيل الدخول إلى عدة أجهزة أو متصفحات.',
    not_found: 'لم يتم العثور على جلسات Aster نشطة. المستخدم ليس مسجلاً حاليًا في أي جهاز.',
    name_column: 'الاسم',
  ...
  third_party_apps: {
    ...
    description:
      'استخدم Aster كمزوّد هوية لتفويض تطبيقات الطرف الثالث. اعرض التطبيقات التي منحها هذا المستخدم صلاحية الوصول وأدرها.',
