...
const upsell = {
  ...
  create_tenant: {
    ...
    description:
      'توفر Aster خيارات خطة تنافسية بأسعار مبتكرة ومعقولة مصممة للشركات الناشئة. <a>تعرف أكثر</a>',
  ...
  mau_exceeded_modal: {
    ...
    notification:
      'لقد تجاوزت MAU الحالي الحد الأقصى لـ <planName/>. يرجى ترقية خطتك إلى النسخة المميزة بسرعة لتجنب تعليق خدمة Aster.',
    update_plan: 'تحديث الخطة',
  },
  token_exceeded_modal: {
    title: 'استخدام الرموز تجاوز الحد المسموح. قم بترقية خطتك.',
    notification:
      'لقد تجاوزت الحد المسموح لاستخدام الرموز لـ <planName/>. لن يتمكن المستخدمون من الوصول إلى خدمة Aster بشكل صحيح. يرجى ترقية خطتك إلى النسخة المميزة بسرعة لتجنب أي إزعاج.',
  },
  payment_overdue_modal: {
    title: 'تأخر في دفع الفاتورة',
    notification:
      'عفوًا! فشلت عملية الدفع لفاتورة المستأجر <span>{{name}}</span>. يرجى دفع الفاتورة بسرعة لتجنب تعليق خدمة Aster.',
  ...
  charge_notification_for_quota_limit:
    'لقد تجاوزت الحد الأقصى لحصة {{item}} الخاصة بك. ستقوم Aster بإضافة رسوم على الاستخدام الزائد لحصتك. ستبدأ عملية الفوترة في اليوم الذي يتم فيه إصدار تصميم التسعير الجديد للإضافة. <a>تعرف أكثر</a>',
  paywall,
