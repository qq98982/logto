const roles = {
  ...
  management_api_access_notification:
    'للوصول إلى واجهة برمجة تطبيقات إدارة Aster، حدد الأدوار ذات الأذونات لواجهة برمجة التطبيقات <flag/>.',
  with_management_api_access_tip:
    'يتضمن هذا الدور من الجهاز إلى الجهاز أذونات واجهة برمجة تطبيقات إدارة Aster',
