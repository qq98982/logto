const usage = {
  ...
  mau: {
    title: 'MAU',
    tooltip:
      'MAU هو مستخدم فريد قام بتبادل رمز واحد على الأقل مع Aster خلال دورة فوترة. غير محدود لخطة Pro. <a>تعرف أكثر</a>',
    tooltip_for_enterprise:
      'MAU هو مستخدم فريد قام بتبادل رمز واحد على الأقل مع Aster خلال دورة فوترة. غير محدود لخطة الشركات.',
  },
  organizations: {
    title: 'المؤسسات',
    tooltip:
