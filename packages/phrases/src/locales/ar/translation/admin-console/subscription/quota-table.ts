const quota_table = {
  ...
  mau_tip:
    'MAU (المستخدم النشط شهريًا) يعني عدد المستخدمين الفريدة الذين قاموا بتبادل رمز واحد على الأقل مع Aster في دورة الفوترة.',
  tokens_tip: 'جميع أنواع الرموز التي تصدرها Aster ، بما في ذلك رمز الوصول ورمز التحديث ، إلخ.',
  mao_tip:
    'MAO (المؤسسة النشطة شهريًا) يعني عدد المؤسسات الفريدة التي لديها مستخدم نشط شهريًا واحد على الأقل في دورة الفوترة.',
  third_party_tip:
    'استخدم Aster كموفر هوية OIDC الخاص بك لتسجيل الدخول ومنح الأذونات لتطبيقات الطرف الثالث.',
