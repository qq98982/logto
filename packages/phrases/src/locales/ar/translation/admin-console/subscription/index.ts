...
const subscription = {
  ...
  free_plan_description: 'للمشاريع الجانبية وتجارب Aster الأولية. بدون بطاقة ائتمان.',
  pro_plan: 'خطة Pro',
  pro_plan_description: 'للاستفادة من الأعمال بدون قلق مع Aster.',
  ...
  payment_error:
    'تم اكتشاف مشكلة في الدفع. تعذر معالجة ${{price, number}} للدورة السابقة. قم بتحديث الدفع لتجنب تعليق خدمة Aster.',
  downgrade: 'تخفيض',
  current: 'الحالي',
  upgrade: 'ترقية',
  quota_table,
  ...
  not_eligible_modal: {
    ...
    upgrade_description:
      'أنت تستخدم حاليًا أكثر مما يسمح به <name />. Aster الآن رسميًا ، بما في ذلك ميزات مصممة خصيصًا لكل خطة. قبل أن تفكر في الترقية إلى <name />, تأكد من تلبية المعايير التالية قبل الترقية.',
  ...
  token_usage_notification: {
    ...
    close_to_limit:
      'أنت على وشك الوصول إلى حد استخدام الرموز المميزة الخاص بك. سيتوقف Aster عن منح الرموز إذا تجاوز استخدامك 100%. يرجى ترقية الخطة المجانية لتجنب أي إزعاج.',
    dev_plan_exceeded: 'لقد وصل هذا المستأجر إلى حد الرموز لكل سياسة حد الكيان في Aster.',
  },
};
