const concurrent_device_limit = {
  ...
  enable_description:
    'عند التمكين، يفرض Aster الحد الأقصى للتصاريح النشطة لكل مستخدم لهذا التطبيق.',
  field: 'حد الأجهزة المتزامنة لكل تطبيق',
  field_description:
    'حدد عدد الأجهزة التي يمكن أن يكون المستخدم مسجلًا الدخول إليها في نفس الوقت. يفرض Aster ذلك عن طريق تحديد التصاريح النشطة ويقوم تلقائيًا بإلغاء أقدم تصريح عند تجاوز الحد.',
