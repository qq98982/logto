const oidc_configs = {
  sessions_card_title: 'جلسات Aster',
  sessions_card_description:
    'خصّص سياسة الجلسات المخزنة في خادم تفويض Aster. تسجّل حالة المصادقة العامة للمستخدم لتمكين تسجيل الدخول الأحادي (SSO) والسماح بإعادة المصادقة الصامتة عبر التطبيقات.',
  ...
  cloud_private_key_rotation_notice:
    'في Cloud، تصبح عملية تدوير المفتاح الخاص فعالة بعد فترة سماح مدتها 4 ساعات.',
};
