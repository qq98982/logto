const api_resource_details = {
  ...
  management_api_settings_description:
    'واجهة برمجة التطبيق لـ Aster هي مجموعة شاملة من واجهات برمجة التطبيق التي تمكن المسؤولين من إدارة مجموعة واسعة من المهام المتعلقة بالهوية، وفرض سياسات الأمان، والامتثال للتشريعات والمعايير.',
  management_api_notice:
    'تمثل هذه الواجهة برمجة التطبيق كيان Aster ولا يمكن تعديلها أو حذفها. قم بإنشاء تطبيق من الجهاز إلى التطبيق لاستدعاء واجهة برمجة التطبيق لـ Aster. <a>تعرف على المزيد</a>',
