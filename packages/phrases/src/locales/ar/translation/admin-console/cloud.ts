const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'المستأجر هو بيئة معزولة حيث يمكنك إدارة هويات المستخدمين والتطبيقات وجميع الموارد الأخرى في Aster.',
    invite_collaborators: 'ادعو مشاركيك عبر البريد الإلكتروني',
    hear_about_us: {
      title: 'كيف سمعت عن Aster لأول مرة؟',
      ...
      options: {
        ...
        powered_by: 'صفحة تسجيل الدخول لتطبيق يستخدم Aster',
  ...
  social_callback: {
    ...
    description:
      'لقد قمت بتسجيل الدخول بنجاح باستخدام حسابك الاجتماعي. لضمان التكامل السلس والوصول إلى جميع ميزات Aster، نوصي بمتابعة تكوين موصلك الاجتماعي الخاص بك.',
    notice:
