...
const application_details = {
  ...
  settings_description:
    '"التطبيق" هو برنامج أو خدمة مسجَّلة يمكنها الوصول إلى معلومات المستخدم أو التصرف نيابةً عنه. تساعد التطبيقات Aster على معرفة من يطلب ماذا، وتتولى إدارة تسجيل الدخول والصلاحيات. املأ الحقول المطلوبة لإتمام المصادقة.',
  integration: 'التكامل',
  ...
  aster_endpoint: 'نقطة نهاية Aster',
  application_id: 'معرف التطبيق',
  application_id_tip:
    'معرف التطبيق الفريد الذي يتم إنشاؤه عادةً بواسطة Aster. يُشير أيضًا إلى "client_id" في OpenID Connect.',
  ...
  always_issue_refresh_token_label:
    'عند التمكين ، ستصدر Aster دائمًا رموز التحديث ، بغض النظر عما إذا تم تقديم "prompt=consent" في طلب المصادقة. ومع ذلك ، يُنصح بعدم استخدام هذه الممارسة إلا إذا كان ضروريًا ، حيث أنها غير متوافقة مع OpenID Connect وقد تسبب مشاكل بالإمكان.',
  ...
  rotate_refresh_token_label:
    'عند التمكين ، سيصدر Aster رمز تحديث جديد لطلبات الرموز عند مرور 70٪ من وقت الحياة الأصلي (TTL) أو تلبية شروط معينة. <a>تعرف على المزيد</a>',
  rotate_refresh_token_label_for_public_clients:
    'عند التمكين ، سيصدر Aster رمز تحديث جديد لكل طلب رمز. <a>تعرف على المزيد</a>',
  ...
  app_domain_description_1:
    'لا تتردد في استخدام نطاقك مع {{domain}} المدعومة بواسطة Aster ، والتي تكون صالحة بشكل دائم.',
  ...
  third_party_settings_description:
    'دمج التطبيقات الخارجية مع Aster كموفر الهوية الخاص بك (IdP) باستخدام OIDC / OAuth 2.0، مع شاشة موافقة لترخيص المستخدم.',
  ...
  permissions: {
    ...
    permission_description_tips:
      'When Aster is used as an Identity Provider (IdP) for authentication in third-party apps, and users are asked for authorization, this description appears on the consent screen.',
    user_title: 'User',
    user_description:
  ...
  saml_idp_name_id_format: {
    ...
    persistent: 'مستمر',
    persistent_description: 'استخدام معرف مستخدم Aster كاسم المعرف',
    transient: 'مؤقت',
    transient_description: 'استخدام معرف مستخدم مؤقت كاسم المعرف',
    unspecified: 'غير محدد',
    unspecified_description: 'استخدام معرف مستخدم Aster كاسم المعرف',
  ...
  saml_app_attribute_mapping: {
    ...
    description: 'أضف تعيينات السمات لمزامنة ملف تعريف المستخدم من Aster إلى تطبيقك.',
    col_aster_claims: 'قيمة Aster',
