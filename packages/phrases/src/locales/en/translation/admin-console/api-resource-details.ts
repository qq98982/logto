const api_resource_details = {
  ...
  management_api_settings_description:
    'The Aster Management API is a comprehensive collection of APIs that empower administrators to manage a wide range of identity-related tasks, enforce security policies, and comply with regulations and standards.',
  management_api_notice:
    'This API represents Aster entity and cannot be modified or deleted. Create a machine-to-machine app to call Aster Management API. <a>Learn more</a>',
