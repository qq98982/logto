const user_details = {
  ...
  sessions: {
    title: 'Sessions',
    description:
      'Manage sessions maintained by the Aster Authorization Server. Revoking an Aster session here prevents automatic consent on future authorization requests.',
    field_name: 'Sessions',
    multiple_signed_in: 'This user has signed into multiple devices or browsers.',
    not_found: 'No active Aster sessions found. The user is not currently signed in on any device.',
    name_column: 'Name',
  ...
  third_party_apps: {
    ...
    description:
      'Use Aster as your identity provider to authorize third-party apps. View and manage the apps this user has granted access to.',
