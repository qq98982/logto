const enterprise_sso = {
  ...
  placeholder_description:
    'Aster has provided many built-in enterprise identity providers to connect, meantime you can create your own with SAML and OIDC protocols.',
  create_modal: {
  ...
  basic_info: {
    ...
    saml: {
      ...
      sign_auth_request_tooltip:
        'Aster signs SAML authentication requests with a generated certificate. Enable only if your identity provider is configured to verify signed requests.',
    ...
    oidc: {
      ...
      redirect_uri_field_custom_domain_description:
        'If you use multiple <a>custom domains</a> in Aster, be sure to add all corresponding callback URIs to your IdP to make SSO work across every domain.\n\nThe default Aster domain is always valid — include it only if you also wish to support SSO under that domain.',
    },
  },
  attribute_mapping: {
    ...
    col_sp_claims: 'Value of service provider (Aster)',
