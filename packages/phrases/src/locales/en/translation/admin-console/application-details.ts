...
const application_details = {
  ...
  settings_description:
    'An "Application" is a registered software or service that can access user info or act for a user. Applications help recognize who’s asking for what from Aster and handle the sign-in and permission. Fill in the required fields for authentication.',
  ...
  application_id_tip:
    'The unique application identifier normally generated by Aster. It also stands for “<a>client_id</a>” in OpenID Connect.',
  ...
  always_issue_refresh_token_label:
    'When enabled, Aster will always issue refresh tokens, regardless of whether `prompt=consent` is presented in the authentication request. However, this practice is discouraged unless necessary, as it is not compatible with OpenID Connect and may potentially cause issues.',
  ...
  rotate_refresh_token_label:
    'When enabled, Aster will issue a new refresh token for token requests when 70% of the original time to live (TTL) has passed or certain conditions are met. <a>Learn more</a>',
  rotate_refresh_token_label_for_public_clients:
    'When enabled, Aster will issue a new refresh token for each token request. <a>Learn more</a>',
  ...
  app_domain_description_1:
    'Feel free to use your domain with {{domain}} powered by Aster, which is permanently valid.',
  ...
  third_party_settings_description:
    'Integrate third-party applications with Aster as your Identity Provider (IdP) using OIDC / OAuth 2.0, featuring a consent screen for user authorization.',
  ...
  saml_idp_name_id_format: {
    ...
    persistent_description: 'Use Aster user ID as Name ID',
    transient: 'Transient',
    transient_description: 'Use one-time user ID as Name ID',
    unspecified: 'Unspecified',
    unspecified_description: 'Use Aster user ID as Name ID',
  ...
  saml_app_attribute_mapping: {
    ...
    description: 'Add attribute mappings to sync user profile from Aster to your application.',
    col_aster_claims: 'Value of Aster',
