const quota_table = {
  ...
  mau_tip:
    'MAU (monthly active user) means the number of unique users who have exchanged at least one token with Aster in a billing cycle.',
  tokens_tip:
    'All kinds of tokens that issued by Aster, including access token, refresh token, etc.',
  mao_tip:
  ...
  third_party_tip:
    'Use Aster as your OIDC identity provider for third-party app sign-ins and permission grants.',
