const usage = {
  ...
  mau: {
    title: 'MAU',
    tooltip:
      'A MAU is a unique user who has exchanged at least one token with Aster within a billing cycle. Unlimited for the Pro Plan. <a>Learn more</a>',
    tooltip_for_enterprise:
      'A MAU is a unique user who has exchanged at least one token with Aster within a billing cycle. Unlimited for the Enterprise Plan.',
  },
  organizations: {
    title: 'Organizations',
    tooltip:
