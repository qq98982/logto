const concurrent_device_limit = {
  ...
  enable_description:
    'When enabled, Aster enforces the maximum active grants per user for this app.',
  field: 'Concurrent device limit per app',
  field_description:
    'Limit how many devices a user can be signed in to at the same time. Aster enforces this by limiting active grants and automatically revokes the oldest grant when the limit is exceeded.',
