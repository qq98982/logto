const get_started = {
  ...
  subtitle: "Quelques choses que vous pouvez faire pour obtenir rapidement de la valeur d'Aster",
  develop: {
  ...
  customize: {
    ...
    preview: {
      ...
      subtitle:
        "Essayez dès maintenant l'expérience de connexion d'Aster pour voir comment cela fonctionne",
    },
    connector: {
      title:
