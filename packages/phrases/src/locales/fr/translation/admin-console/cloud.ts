const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'Un locataire est un environnement isolé où vous pouvez gérer les identités des utilisateurs, les applications et toutes les autres ressources Aster.',
    invite_collaborators: 'Invitez vos collaborateurs par e-mail',
    hear_about_us: {
      title: "Comment avez-vous entendu parler d'Aster pour la première fois ?",
      ...
      options: {
        ...
        powered_by: "Page de connexion d'une application utilisant Aster",
  ...
  social_callback: {
    ...
    description:
      "Vous vous êtes connecté avec succès en utilisant votre compte social. Pour assurer une intégration fluide et accéder à toutes les fonctionnalités d'Aster, nous vous recommandons de configurer votre propre connecteur social.",
    notice:
