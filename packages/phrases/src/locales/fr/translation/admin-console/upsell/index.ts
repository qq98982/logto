...
const upsell = {
  ...
  create_tenant: {
    ...
    description:
      'Aster propose des options de plan compétitives avec une tarification innovante et abordable conçue pour les entreprises en croissance. <a>En savoir plus</a>',
  ...
  mau_exceeded_modal: {
    ...
    notification:
      'Votre MAU actuel a dépassé la limite de <planName/>. Veuillez mettre à niveau votre plan pour passer à la version premium rapidement et éviter la suspension du service Aster.',
  ...
  token_exceeded_modal: {
    ...
    notification:
      "Vous avez dépassé la limite d'utilisation des jetons de <planName/>. Les utilisateurs ne pourront pas accéder correctement au service Aster. Veuillez mettre à niveau votre plan vers la version premium rapidement pour éviter tout inconvénient.",
  },
  payment_overdue_modal: {
    title: 'Paiement de facture en retard',
    notification:
      'Oups ! Le paiement de la facture du locataire <span>{{name}}</span> a échoué. Veuillez payer la facture rapidement pour éviter la suspension du service Aster.',
  ...
  charge_notification_for_quota_limit:
    "Vous avez dépassé votre limite de quota {{item}}. Aster ajoutera des frais pour l'utilisation au-delà de votre limite de quota. La facturation commencera le jour de la publication du nouveau design tarifaire de l'extension. <a>En savoir plus</a>",
  paywall,
