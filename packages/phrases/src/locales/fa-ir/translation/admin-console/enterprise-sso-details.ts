const enterprise_sso_details = {
  ...
  service_provider_property_description:
    'یک یکپارچه‌سازی برنامه با استفاده از {{protocol}} در ارائه‌دهنده هویت خود تنظیم کنید. جزئیات ارائه‌شده توسط Aster را وارد کنید.',
  attribute_mapping_title: 'نگاشت ویژگی‌ها',
  attribute_mapping_description:
    'پروفایل‌های کاربر را از ارائه‌دهنده هویت با پیکربندی نگاشت ویژگی‌های کاربر از ارائه‌دهنده هویت به سمت Aster همگام‌سازی کنید.',
  saml_preview: {
  ...
  idp_initiated_auth_config: {
    ...
    redirect_uri_tooltip:
      'URI تغییر مسیر برای هدایت کاربران پس از ورود موفق. Aster از این URI به عنوان URI تغییر مسیر OIDC در درخواست مجوز استفاده می‌کند. برای امنیت بیشتر، از یک URI اختصاصی برای جریان احراز هویت SSO آغازشده توسط IdP استفاده کنید.',
