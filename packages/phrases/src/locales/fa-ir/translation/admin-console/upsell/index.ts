...
const upsell = {
  ...
  create_tenant: {
    ...
    description:
      'Aster گزینه‌های پلان رقابتی با قیمت‌گذاری نوآورانه و مقرون‌به‌صرفه برای شرکت‌های در حال رشد ارائه می‌دهد. <a>بیشتر بدانید</a>',
  ...
  mau_exceeded_modal: {
    ...
    notification:
      'MAU فعلی شما از حد مجاز <planName/> عبور کرده است. لطفاً پلان خود را سریعاً به پرمیوم ارتقا دهید تا از تعلیق سرویس Aster جلوگیری شود.',
    update_plan: 'به‌روزرسانی پلان',
  },
  token_exceeded_modal: {
    title: 'مصرف توکن از حد مجاز عبور کرده است. پلان خود را ارتقا دهید.',
    notification:
      'شما از حد مجاز مصرف توکن <planName/> عبور کرده‌اید. کاربران نمی‌توانند به درستی به سرویس Aster دسترسی داشته باشند. لطفاً پلان خود را سریعاً به پرمیوم ارتقا دهید تا از هرگونه مشکل جلوگیری شود.',
  },
  payment_overdue_modal: {
    title: 'پرداخت صورت‌حساب عقب افتاده است',
    notification:
      'اوه! پرداخت صورت‌حساب tenant <span>{{name}}</span> ناموفق بود. لطفاً صورت‌حساب را سریعاً پرداخت کنید تا از تعلیق سرویس Aster جلوگیری شود.',
  ...
  charge_notification_for_quota_limit:
    'شما از حد سهمیه {{item}} خود عبور کرده‌اید. Aster برای استفاده بیش از حد سهمیه شما هزینه اضافه خواهد کرد. پرداخت از روز انتشار طرح قیمت‌گذاری جدید add-on آغاز خواهد شد. <a>بیشتر بدانید</a>',
  paywall,
