const usage = {
  ...
  mau: {
    title: 'MAU',
    tooltip:
      'MAU یک کاربر منحصربه‌فرد است که در طول یک دوره صورت‌حساب حداقل یک توکن با Aster مبادله کرده است. برای پلن Pro نامحدود است. <a>بیشتر بدانید</a>',
    tooltip_for_enterprise:
      'MAU یک کاربر منحصربه‌فرد است که در طول یک دوره صورت‌حساب حداقل یک توکن با Aster مبادله کرده است. برای پلن Enterprise نامحدود است.',
  },
  organizations: {
    title: 'سازمان‌ها',
    tooltip:
