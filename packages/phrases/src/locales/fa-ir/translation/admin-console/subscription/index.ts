...
const subscription = {
  ...
  free_plan_description: 'برای پروژه‌های جانبی و آزمایش اولیه Aster. بدون نیاز به کارت اعتباری.',
  pro_plan: 'پلن حرفه‌ای',
  pro_plan_description: 'برای کسب‌وکارهایی که می‌خواهند بدون نگرانی از Aster استفاده کنند.',
  ...
  payment_error:
    'مشکل پرداخت شناسایی شد. پردازش ${{price, number}} برای دوره قبلی امکان‌پذیر نیست. پرداخت را به‌روز کنید تا از تعلیق سرویس Aster جلوگیری شود.',
  downgrade: 'کاهش پلن',
  current: 'فعلی',
  upgrade: 'ارتقا',
  quota_table,
  ...
  not_eligible_modal: {
    ...
    upgrade_description:
      'شما در حال حاضر بیش از آنچه <name /> اجازه می‌دهد استفاده می‌کنید. Aster اکنون رسمی شده و شامل ویژگی‌های مخصوص هر پلن است. قبل از ارتقا به <name />، مطمئن شوید که معیارهای زیر را دارید.',
  ...
  token_usage_notification: {
    ...
    close_to_limit:
      'شما به محدودیت استفاده از توکن نزدیک شده‌اید. در صورتی که استفاده شما از ۱۰۰٪ بیشتر شود، Aster صدور توکن را متوقف خواهد کرد. لطفاً پلن رایگان را ارتقا دهید تا از هرگونه مشکلی جلوگیری شود.',
    dev_plan_exceeded: 'این مستأجر به محدودیت توکن بر اساس سیاست محدودیت موجودیت Aster رسیده است.',
  },
};
