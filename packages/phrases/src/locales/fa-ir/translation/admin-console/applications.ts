const applications = {
  ...
  subtitle_with_app_type: 'احراز هویت Aster را برای برنامه {{name}} خود راه‌اندازی کنید',
  ...
  type: {
    ...
    protected: {
      ...
      subtitle: 'برنامه‌ای که توسط Aster محافظت می‌شود', // Not in use
  ...
  placeholder_description:
    'Aster از یک موجودیت برنامه برای OIDC استفاده می‌کند تا در کارهایی مانند شناسایی برنامه‌ها، مدیریت ورود و ایجاد گزارش‌های حسابرسی کمک کند.',
  third_party_application_placeholder_description:
    'از Aster به‌عنوان Identity Provider برای ارائه مجوز OAuth به سرویس‌های شخص ثالث استفاده کنید. شامل یک صفحه رضایت کاربر از پیش‌ساخته برای دسترسی به منابع می‌شود. <a>بیشتر بدانید</a>',
  guide: {
    third_party: {
      title: 'یکپارچه‌سازی برنامه شخص ثالث',
      description:
        'از Aster به‌عنوان Identity Provider خود برای ارائه مجوز OAuth به سرویس‌های شخص ثالث استفاده کنید. شامل یک صفحه رضایت کاربر از پیش‌ساخته برای دسترسی ایمن به منابع می‌شود. <a>بیشتر بدانید</a>',
    },
  },
};
