const webhook_details = {
  ...
  settings: {
    ...
    events: 'رویدادها',
    events_description:
      'رویدادهای ماشه‌ای را انتخاب کنید که Aster درخواست POST را برای آن‌ها ارسال می‌کند.',
    name: 'نام',
    endpoint_url: 'URL مقصد',
    signing_key: 'کلید امضا',
    signing_key_tip:
      'کلید مخفی ارائه‌شده توسط Aster را به‌عنوان هدر درخواست به مقصد اضافه کنید تا اصالت بار وب‌هوک تضمین شود.',
