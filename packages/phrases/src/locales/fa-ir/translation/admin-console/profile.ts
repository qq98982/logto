const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        'حذف حساب شما همه داده‌های مربوط به شما در Cloud را برای همیشه حذف می‌کند. لطفاً قبل از ادامه داده‌های مهم را پشتیبان بگیرید.',
      confirm_information:
    ...
    try_again_later:
      'لطفاً بعداً دوباره تلاش کنید. اگر مشکل ادامه داشت، با تیم Aster و شناسه درخواست تماس بگیرید.',
