const oidc_configs = {
  sessions_card_title: 'نشست‌های Aster',
  sessions_card_description:
    'سیاست نشست ذخیره‌شده توسط سرور مجوز Aster را سفارشی کنید. این سیاست وضعیت احراز هویت سراسری کاربر را ثبت می‌کند تا SSO را فعال و احراز هویت مجدد بی‌صدا در برنامه‌ها را ممکن سازد.',
