const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'مستأجر یک محیط ایزوله است که در آن می‌توانید هویت‌های کاربری، برنامه‌ها و تمام منابع دیگر Aster را مدیریت کنید.',
    invite_collaborators: 'همکاران خود را از طریق ایمیل دعوت کنید',
    hear_about_us: {
      title: 'اولین بار چگونه با Aster آشنا شدید؟',
      ...
      options: {
        ...
        powered_by: 'صفحه ورود برنامه‌ای که از Aster استفاده می‌کند',
  ...
  social_callback: {
    ...
    description:
      'شما با موفقیت با استفاده از حساب اجتماعی خود وارد شده‌اید. برای اطمینان از یکپارچه‌سازی بدون مشکل و دسترسی به تمام ویژگی‌های Aster، توصیه می‌کنیم که اتصال‌دهنده اجتماعی خود را پیکربندی کنید.',
    notice:
