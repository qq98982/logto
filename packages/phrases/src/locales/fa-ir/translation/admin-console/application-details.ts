...
const application_details = {
  ...
  settings_description:
    '"برنامه" یک نرم‌افزار یا سرویس ثبت‌شده است که می‌تواند به اطلاعات کاربر دسترسی داشته باشد یا به نمایندگی از کاربر عمل کند. برنامه‌ها کمک می‌کنند تشخیص دهیم چه کسی چه چیزی از Aster می‌خواهد و ورود و مجوزها را مدیریت می‌کنند. فیلدهای الزامی را برای احراز هویت پر کنید.',
  ...
  aster_endpoint: 'نقطه پایانی Aster',
  application_id: 'شناسه برنامه',
  application_id_tip:
    'شناسه منحصربه‌فرد برنامه که معمولاً توسط Aster تولید می‌شود. همچنین به عنوان "<a>client_id</a>" در OpenID Connect شناخته می‌شود.',
  ...
  always_issue_refresh_token_label:
    'هنگامی که فعال است، Aster همیشه توکن‌های بازیابی صادر می‌کند، صرف‌نظر از اینکه `prompt=consent` در درخواست احراز هویت ارائه شده باشد یا نه. با این حال، این رویه توصیه نمی‌شود مگر در صورت نیاز، زیرا با OpenID Connect سازگار نیست و ممکن است مشکلاتی ایجاد کند.',
  ...
  rotate_refresh_token_label:
    'هنگامی که فعال است، Aster یک توکن بازیابی جدید برای درخواست‌های توکن صادر می‌کند زمانی که ۷۰٪ از مدت زمان زندگی اصلی (TTL) گذشته باشد یا شرایط خاصی برآورده شود. <a>بیشتر بدانید</a>',
  rotate_refresh_token_label_for_public_clients:
    'هنگامی که فعال است، Aster برای هر درخواست توکن یک توکن بازیابی جدید صادر می‌کند. <a>بیشتر بدانید</a>',
  ...
  app_domain_description_1:
    'می‌توانید از دامنه خود با {{domain}} که توسط Aster پشتیبانی می‌شود و برای همیشه معتبر است استفاده کنید.',
  ...
  third_party_settings_description:
    'برنامه‌های شخص ثالث را با Aster به عنوان ارائه‌دهنده هویت (IdP) با استفاده از OIDC / OAuth 2.0 یکپارچه کنید، با صفحه رضایت برای مجوز کاربر.',
  ...
  permissions: {
    ...
    permission_description_tips:
      'هنگامی که Aster به عنوان یک ارائه‌دهنده هویت (IdP) برای احراز هویت در برنامه‌های شخص ثالث استفاده می‌شود و از کاربران مجوز درخواست می‌شود، این توضیحات در صفحه رضایت نمایش داده می‌شود.',
    user_title: 'کاربر',
    user_description:
  ...
  saml_idp_name_id_format: {
    ...
    persistent: 'پایدار',
    persistent_description: 'استفاده از شناسه کاربر Aster به عنوان شناسه نام',
    transient: 'موقت',
    transient_description: 'استفاده از شناسه کاربر یک‌بار مصرف به عنوان شناسه نام',
    unspecified: 'نامشخص',
    unspecified_description: 'استفاده از شناسه کاربر Aster به عنوان شناسه نام',
  ...
  saml_app_attribute_mapping: {
    ...
    description:
      'نگاشت‌های ویژگی را برای همگام‌سازی پروفایل کاربر از Aster به برنامه خود اضافه کنید.',
    col_aster_claims: 'مقدار Aster',
