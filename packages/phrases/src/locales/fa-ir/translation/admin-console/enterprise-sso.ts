const enterprise_sso = {
  ...
  placeholder_description:
    'Aster ارائه‌دهندگان هویت سازمانی داخلی متعددی برای اتصال فراهم کرده است، همچنین می‌توانید با پروتکل‌های SAML و OIDC اتصال‌دهنده خود را بسازید.',
  create_modal: {
  ...
  basic_info: {
    ...
    saml: {
      ...
      sign_auth_request_tooltip:
        'Aster درخواست‌های احراز هویت SAML را با گواهی تولیدشده امضا می‌کند. فقط در صورتی فعال کنید که ارائه‌دهنده هویت شما برای تأیید درخواست‌های امضاشده پیکربندی شده باشد.',
    ...
    oidc: {
      ...
      redirect_uri_field_custom_domain_description:
        'اگر از چندین <a>دامنه سفارشی</a> در Aster استفاده می‌کنید، مطمئن شوید که تمام URI‌های callback مربوطه را به ارائه‌دهنده هویت خود اضافه کرده‌اید تا SSO در همه دامنه‌ها کار کند.\n\nدامنه پیش‌فرض Aster همیشه معتبر است — آن را فقط در صورتی که می‌خواهید SSO را در آن دامنه نیز پشتیبانی کنید، اضافه کنید.',
    },
  },
  attribute_mapping: {
    ...
    col_sp_claims: 'مقدار ارائه‌دهنده خدمات (Aster)',
