const oss_onboarding = {
  ...
  description:
    'کمی درباره خود و پروژه‌تان بگویید. این به ما کمک می‌کند Aster بهتری برای همه بسازیم.',
  email: {
    label: 'آدرس ایمیل',
    description: 'در صورت نیاز به تماس درباره حساب شما از این آدرس استفاده می‌کنیم.',
    placeholder: 'email@example.com',
  },
  newsletter: 'به‌روزرسانی محصول، توصیه‌های امنیتی و محتوای منتخب Aster را دریافت کنید.',
  project: {
    label: 'از Aster برای',
    personal: 'پروژه شخصی',
    company: 'پروژه شرکتی',
