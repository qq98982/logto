const api_resource_details = {
  ...
  management_api_settings_description:
    'Aster Management API مجموعه‌ای جامع از APIها است که به مدیران امکان می‌دهد طیف گسترده‌ای از وظایف مرتبط با هویت را مدیریت کنند، سیاست‌های امنیتی را اعمال نمایند و با مقررات و استانداردها مطابقت داشته باشند.',
  management_api_notice:
    'این API نمایانگر موجودیت Aster است و قابل تغییر یا حذف نیست. برای فراخوانی Aster Management API یک برنامه ماشین-به-ماشین ایجاد کنید. <a>بیشتر بدانید</a>',
