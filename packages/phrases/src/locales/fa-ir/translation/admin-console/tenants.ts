const tenants = {
  ...
  settings: {
    ...
    tenant_instance_description:
      'محل میزبانی مستأجر خود را انتخاب کنید. Cloud را برای زیرساخت اشتراکی عمومی یا نمونه خصوصی برای منابع اختصاصی انتخاب کنید.',
    ...
    enterprise_sso_description:
      'در طرح‌های پولی در دسترس است. برای فعال‌سازی SSO سازمانی تا همه اعضا بتوانند با ارائه‌دهنده هویت سازمان خود به کنسول Cloud وارد شوند، با ما تماس بگیرید.',
  },
  full_env_tag: {
    development: 'توسعه',
    production: 'تولید',
  ...
  create_modal: {
    ...
    tenant_id_tip:
      'شناسه مستأجر را سفارشی کنید. اگر خالی بماند، Aster شناسه پیش‌فرض تولید می‌کند. شناسه مستأجر پس از ایجاد قابل تغییر نیست.',
  },
  ...
  tenant_landing_page: {
    ...
    description:
      'برای شروع پیکربندی پروژه با Aster، لطفاً مستأجر جدیدی ایجاد کنید. اگر می‌خواهید خارج شوید یا حساب را حذف کنید، روی دکمه آواتار در گوشه بالا سمت راست کلیک کنید.',
