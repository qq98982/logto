...
describe('validatePostSignInActionResult', () => {
  ...
  // A script result reaches validation after a structured-clone round trip across the thread
  // boundary, so it is a plain object from another realm — validation must still treat it as a
  // no-op.
