const user_scopes = {
  descriptions: {
    ...
    'urn:aster:scope:organizations': 'ข้อมูลองค์กรของคุณ',
    'urn:aster:scope:organization_roles': 'บทบาทในองค์กรของคุณ',
    address: 'ที่อยู่ของคุณ',
    'urn:aster:scope:sessions': 'เซสชันที่ใช้งานอยู่ของคุณ',
  },
};
