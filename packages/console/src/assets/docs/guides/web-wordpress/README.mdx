...
We will use the [OpenID Connect Generic](https://wordpress.org/plugins/generic-openid-connect/) plugin to integrate Aster via OIDC protocal into your Wordpress website.
...
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Client ID                     | The app ID of your Aster application                                                                                                                                                            |
| Client Secret                 | The app secret of your Aster application                                                                                                                                                        |
| OpenID Scope                  | Enter `email profile openid offline_access`                                                                                                                                                     |
| Login Endpoint URL            | The authorization endpoint shown in your Aster application's endpoint details. |
| Userinfo Endpoint URL         | The userinfo endpoint shown in your Aster application's endpoint details. |
| Token Validation Endpoint URL | The token endpoint shown in your Aster application's endpoint details. |
| End Session Endpoint URL      | The end-session endpoint shown in your Aster application's endpoint details. |
...
2. Visit the WordPress login page and click the "Sign in with Aster" button.
