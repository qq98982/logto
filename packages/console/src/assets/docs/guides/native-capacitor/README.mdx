...
Run the Capacitor app and click the sign-in button. A browser window will open, redirecting to the Aster sign-in page.
...
The `signOut` method has an optional parameter for the post sign-out redirect URI. If it's not provided, the user will be redirected to the Aster sign-out page:
...
Then click the sign-out button, and the Capacitor app will be redirected to the Aster sign-out page. It will automatically redirect back to the Capacitor app if the post sign-out redirect URI is configured.
