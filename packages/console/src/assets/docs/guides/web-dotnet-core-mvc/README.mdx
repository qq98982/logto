...
<Step title="Add the upstream SDK as a dependency">

<Installation />

</Step>

<Step title="Add Aster authentication">
...
public class HomeController : Controller
{
  ...
  {
    // This will redirect the user to the Aster sign-in page.
  ...
  {
    // This will clear the authentication cookie and redirect the user to the Aster sign-out page
    // to clear the Aster session as well.
