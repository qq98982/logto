...
<Step
  title="Add the upstream SDK as a dependency"
...
In the file where you want to initialize the Aster client (e.g. a base controller or a middleware), add the following code:
...
class SampleController < ApplicationController
  ...
  def initialize_logto_client
    @client = LogtoClient.new(
      ...
      # Allow the client to redirect to other hosts (i.e. your Aster tenant)
