...
<Step title="Set up email sign-in in Aster">
...
See Passwordless sign-in by adding connectors to learn more about configuring passwordless sign-in in Aster.

</Step>

<Step title="Checkpoint: Test Aster and Outline integration">
...
Click on the button, and you will be directed to the Aster sign-in experience.

If everything has been configured correctly, once you complete the sign-in or registration process in Aster, you will be redirected back to Outline. You can then see your personal information displayed in the bottom left corner of the page.
