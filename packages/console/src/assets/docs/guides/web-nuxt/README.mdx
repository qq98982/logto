...
<InlineNotification severity="alert">
  the upstream Nuxt SDK only works with Nuxt 3.
</InlineNotification>
...
<Step title="Register Aster module">

In your Nuxt config file, add the Aster module and configure it:
...
<InlineNotification>
If you configure the callback route to a different path, you need to update the redirect URI in Aster accordingly.
</InlineNotification>
