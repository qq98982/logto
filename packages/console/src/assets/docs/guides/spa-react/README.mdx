...
Import and use `LogtoProvider` to provide an Aster context to your app:
...
After the user signs in, Aster will redirect the user back to the redirect URI configured above. However, there are still things to do to make your application work properly.
